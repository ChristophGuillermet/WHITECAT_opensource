...
if(player_is_playing[player]==1){player1->setPosition(0);player1->play(); }
...
player_ignited[player]=1;
if(player_is_playing[player]==1){player2->setPosition(0);player2->play(); }
...
player_ignited[player]=1;
if(player_is_playing[player]==1){player3->setPosition(0);player3->play(); }
...
player_ignited[player]=1;
if(player_is_playing[player]==1){player4->setPosition(0);player4->play(); }
...
if(mouse_x>xb+355 && mouse_x<xb+355+150 && mouse_y>(yb+45+(y*20)-10) && mouse_y<(yb+45+(y*20)+5))
{         
