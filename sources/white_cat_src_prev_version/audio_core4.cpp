...
player1->setVolume(((float)player_niveauson[player]+sqrt((float)player_niveauson[player]))/127);
...
player_loop_out_position[player]=length_of_file_in_player[player];
player2->setVolume(((float)player_niveauson[player]+sqrt((float)player_niveauson[player]))/127);
switch(player_is_onloop[player]) 
 {
 case 0:
...
player_loop_out_position[player]=length_of_file_in_player[player];
player3->setVolume(((float)player_niveauson[player]+sqrt((float)player_niveauson[player]))/127);
switch(player_is_onloop[player]) 
 {
 case 0:
...
player_loop_out_position[player]=length_of_file_in_player[player];
player4->setVolume(((float)player_niveauson[player]+sqrt((float)player_niveauson[player]))/127);
switch(player_is_onloop[player]) 
 {
 case 0:
...
case 0://VOLUME
     ...
     {
     case 0:
     player1->setVolume(((float)player_niveauson[player_to_remote]+sqrt((float)player_niveauson[player_to_remote]))/127);
     break;      
     case 1:
     player2->setVolume(((float)player_niveauson[player_to_remote]+sqrt((float)player_niveauson[player_to_remote]))/127);
     break; 
     case 2:
     player3->setVolume(((float)player_niveauson[player_to_remote]+sqrt((float)player_niveauson[player_to_remote]))/127);
     break; 
     case 3:
     player4->setVolume(((float)player_niveauson[player_to_remote]+sqrt((float)player_niveauson[player_to_remote]))/127);
     break;                                       
     }
     }
break;      
...
{
case 0:
player1->setVolume(((float)player_niveauson[numero]+sqrt((float)player_niveauson[numero]))/127);
break;      
case 1:
player2->setVolume(((float)player_niveauson[numero]+sqrt((float)player_niveauson[numero]))/127);
break; 
case 2:
player3->setVolume(((float)player_niveauson[numero]+sqrt((float)player_niveauson[numero]))/127);
break; 
case 3:
player4->setVolume(((float)player_niveauson[numero]+sqrt((float)player_niveauson[numero]))/127);
break;       
}
