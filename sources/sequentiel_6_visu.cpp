...
if(mouse_x> x_seq+10 && mouse_x<x_seq+50)//DELAYS
{
Rect DelayOver (Vec2D (x_seq+10, y_seq+145 ), Vec2D ( 40,20));
DelayOver.SetRoundness(7.5);
DelayOver.DrawOutline(CouleurLigne);     
}
if(mouse_x> x_seq+50 && mouse_x<x_seq+110)//IN OUT
{
Rect InOutOver (Vec2D (x_seq+50, y_seq+140), Vec2D ( 60,20));
InOutOver.SetRoundness(7.5);
InOutOver.DrawOutline(CouleurLigne);         
}
if(mouse_x> x_seq+110 && mouse_x<x_seq+170)//MEMS
{
Rect MemOver (Vec2D (x_seq+110, y_seq+145), Vec2D ( 60,20));
MemOver.SetRoundness(7.5);
MemOver.DrawOutline(CouleurLigne); 
}
if(mouse_x> x_seq+180 && mouse_x<x_seq+215)//LINKS
{
Rect LinkOver (Vec2D (x_seq+180, y_seq+145 ), Vec2D ( 35,20));
LinkOver.SetRoundness(7.5);
LinkOver.DrawOutline(CouleurLigne);       
}
if(mouse_x> x_seq+225 && mouse_x<x_seq+265)//BANGER
{
Rect bangOver (Vec2D (x_seq+225, y_seq+145 ), Vec2D ( 40,20));
bangOver.SetRoundness(7.5);
bangOver.DrawOutline(CouleurLigne); 
}
if(mouse_x>x_seq+270 && mouse_x<x_seq+300)//GRID PLAYER
{
Rect Gpl1Over (Vec2D (x_seq+275, y_seq+145 ), Vec2D ( 30,20));
Gpl1Over.SetRoundness(7.5);
Gpl1Over.DrawOutline(CouleurLigne);                      
}
if(mouse_x> x_seq+310 && mouse_x<x_seq+470)//TEXT DECRIPTION
{
Rect TextOver (Vec2D (x_seq+310, y_seq+140), Vec2D ( 160,15));
TextOver.SetRoundness(5);
...
{
Rect ExclueBf(Vec2D(x_seq+170,y_seq+80),Vec2D(10,30));
ExclueBf.Draw(CouleurYellow.WithAlpha(alpha_blinker*(MemoiresExclues[mem_before_one])));

Rect ExclueSt(Vec2D(x_seq+170,y_seq+110),Vec2D(10,30));
ExclueSt.Draw(CouleurYellow.WithAlpha(alpha_blinker*(MemoiresExclues[position_onstage])));

Rect ExcluePst(Vec2D(x_seq+170,y_seq+140),Vec2D(10,30));
ExcluePst.Draw(CouleurYellow.WithAlpha(alpha_blinker*(MemoiresExclues[position_preset])));
}
...
if(mouse_x> x_seq+180 && mouse_x<x_seq+215)//LINKS
{
Rect LinkOver (Vec2D (x_seq+180,y_seq+80), Vec2D (35,20));
LinkOver.SetRoundness(7.5);
LinkOver.DrawOutline(CouleurLigne);         
}
...
if(mouse_x> x_seq+225 && mouse_x<x_seq+265)//BANGER
{
Rect bangOver (Vec2D (x_seq+225, y_seq+80), Vec2D ( 40,20));
bangOver.SetRoundness(7.5);
bangOver.DrawOutline(CouleurLigne);     
}
if(mouse_x>x_seq+270 && mouse_x<x_seq+300)//GRID PLAYER
{
Rect Gpl1Over (Vec2D (x_seq+275, y_seq+80), Vec2D ( 30,20));
Gpl1Over.SetRoundness(7.5);
Gpl1Over.DrawOutline(CouleurLigne);                      
}
if(mouse_x> x_seq+310 && mouse_x<x_seq+470)//TEXT DECRIPTION
{
Rect TextOver (Vec2D (x_seq+310, y_seq+80), Vec2D ( 160,15));
TextOver.SetRoundness(5);
...
if(index_is_saving==0 && init_done==1 && index_writing_curve==0 && index_quit==0)
{
Rect ExclueMe(Vec2D(x_seq+170,y_seq+135+(35*index_nbre_mem_visues)),Vec2D(10,35));
ExclueMe.Draw(CouleurYellow.WithAlpha(alpha_blinker*(MemoiresExclues[memsearch])));
}
if(window_focus_id==W_SEQUENCIEL)
{
///ACTIONS
if(mouse_y>y_seq+145+(35*index_nbre_mem_visues)  && mouse_y< y_seq+175+(35*index_nbre_mem_visues))
{
                                                                                                 
if(mouse_x> x_seq+110 && mouse_x<x_seq+170)//MEMS
{
Rect MemOver (Vec2D (x_seq+110,y_seq+145+(35*index_nbre_mem_visues)), Vec2D ( 60,20));
MemOver.SetRoundness(7.5);
MemOver.DrawOutline(CouleurLigne);    
}
...
if(mouse_x> x_seq+180 && mouse_x<x_seq+215)//LINKS
{
Rect LinkOver (Vec2D (x_seq+180,y_seq+145+(35*index_nbre_mem_visues)), Vec2D ( 35,20));
LinkOver.SetRoundness(7.5);
LinkOver.DrawOutline(CouleurLigne);  
}
if(mouse_x> x_seq+225 && mouse_x<x_seq+265)//BANGER
{
Rect bangOver (Vec2D (x_seq+225, y_seq+145+(35*index_nbre_mem_visues) ), Vec2D ( 40,20));
bangOver.SetRoundness(7.5);
bangOver.DrawOutline(CouleurLigne);     
}
if(mouse_x>x_seq+270 && mouse_x<x_seq+300)//GRID PLAYER
{
Rect Gpl1Over (Vec2D (x_seq+275, y_seq+145+(35*index_nbre_mem_visues) ), Vec2D ( 30,20));
Gpl1Over.SetRoundness(7.5);
Gpl1Over.DrawOutline(CouleurLigne);                      
}
if(mouse_x> x_seq+310 && mouse_x<x_seq+470)//TEXT DECRIPTION
{
Rect TextOver (Vec2D (x_seq+310, y_seq+140+(35*index_nbre_mem_visues)), Vec2D ( 160,15));
TextOver.SetRoundness(5);

if(mouse_y> y_seq+140+(35*index_nbre_mem_visues) && mouse_y < y_seq+155+(35*index_nbre_mem_visues))
{
TextOver.DrawOutline(CouleurLigne);             
}
else
{
TextOver.MoveTo(Vec2D (x_seq+310, y_seq+155+(35*index_nbre_mem_visues))); 
TextOver.DrawOutline(CouleurLigne);    
}                        
...
////////////////////X2////////////////////////////////////////////////////////////////
if(mouse_x> x_seq+580 && mouse_x< x_seq+625)
{
...
{
X1X2Together.Draw(CouleurFader);
}
...
if(Midi_Force_Go==1){GoTouch.DrawOutline(CouleurGreen);}

if(window_focus_id==W_SEQUENCIEL && mouse_x>x_seq+534 && mouse_x<x_seq+574 && mouse_y>y_seq+355 && mouse_y<y_seq+395)
{
GoTouch.Draw(CouleurSurvol);
GoTouch.DrawOutline(CouleurLigne);
...
if(index_go==1)
{
GoTouch.Draw(CouleurFader); GoTouch.DrawOutline(CouleurLigne);
if(index_pause==1)
{
GoTouch.Draw(CouleurFond.WithAlpha(alpha_blinker)); GoTouch.DrawOutline(CouleurLigne);  
}  
}
...
if(window_focus_id==W_SEQUENCIEL && mouse_x>x_seq+484 && mouse_x<x_seq+524 && mouse_y>y_seq+355 && mouse_y<y_seq+395)
{
GoBackTouch.Draw(CouleurSurvol);    
GoBackTouch.DrawOutline(CouleurLigne);
if( Midi_Faders_Affectation_Type!=0)//config midi
{
...
if(index_go_back==1)
{
GoBackTouch.Draw(CouleurFader);GoBackTouch.DrawOutline(CouleurLigne);

if(index_pause==1)
{
GoBackTouch.Draw(CouleurFond.WithAlpha(alpha_blinker));GoBackTouch.DrawOutline(CouleurLigne);
}
}
...
if(window_focus_id==W_SEQUENCIEL && mouse_x>x_seq+584 && mouse_x<x_seq+624 && mouse_y>y_seq+355 && mouse_y<y_seq+395)
{
DoubleGoTouch.Draw(CouleurSurvol);  DoubleGoTouch.DrawOutline(CouleurLigne);            
...
if(window_focus_id==W_SEQUENCIEL && mouse_x> x_seq+548 && mouse_x<  x_seq+563 && mouse_y>y_seq+435 && mouse_y<y_seq+450 && Midi_Faders_Affectation_Type!=0)
{
char sttmp[24];
...
if(window_focus_id==W_SEQUENCIEL && mouse_x>=x_seq+490 && mouse_x<=x_seq+617 && mouse_y>y_seq+405 && mouse_y<y_seq+427)
{
//midi report 
...
Rect SeqAction(Vec2D (xseq+20+(op*60),rangee_y), Vec2D ( 50,20));
SeqAction.SetRoundness(7.5);

//affichage
SeqAction.DrawOutline(CouleurLigne);  
if(window_focus_id==W_SEQUENCIEL && mouse_x>xseq+20+(op*60) && mouse_x<xseq+70+(op*60) && mouse_y>  rangee_y && mouse_y<  rangee_y+20 
   &&  Midi_Faders_Affectation_Type!=0)//config midi
{
