...
Rect OverKey(Vec2D(x_cfg,y_cfg),Vec2D(60,25));
OverKey.SetRoundness(2.0);
for(int i=0;i<11;i++)
{
OverKey.MoveTo(Vec2D(x_cfg,y_cfg+15+(i*30)));
OverKey.Draw(CouleurFond.WithAlpha(0.5));  
petitchiffre.Print(kbd_custom[index_liste_kbd_custom+i],x_cfg+10,y_cfg+20+(i*30));       
}
return(0);
}
