...
{
ol::Rect On(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
On.SetRoundness(4);
...
{
ol::Rect Texn(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
Texn.SetRoundness(4);
...
ol::Circle Rot(ol::Vec2D(xr,yr),Rrayon);
...
for(double v=-PI ;v<=PI ;v+=(PI/6))
{
 Vx=cos(v)*Rrayon;
 Vy=sin(v)*Rrayon;
 ol::Line(ol::Vec2D(xr,yr),ol::Vec2D(xr+Vx,yr+Vy)).Draw(CouleurFond);
}
Vx=cos(((2*PI)-valeur)-2)*Rrayon;
Vy=sin(((2*PI)-valeur)-2)*Rrayon;
ol::Line Curseur(ol::Vec2D(xr,yr),ol::Vec2D(xr+Vx,yr+Vy));
...
{
ol::Rect Play(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
Play.SetRoundness(4);
if(state==1){Play.Draw(CouleurFader);}
Play.DrawOutline(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+4),ol::Vec2D(xp+6,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+4),ol::Vec2D(xp+16,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+16),ol::Vec2D(xp+16,yp+10)).Draw(CouleurLigne);
if(mouse_x>xp && mouse_x<xp+20 && mouse_y>yp && mouse_y<yp+20)
{
if(Midi_Faders_Affectation_Type!=0)//config midi
{
...
{
//SEEK TO 0
ol::Rect SeekToZero(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
SeekToZero.SetRoundness(4);
ol::Line(ol::Vec2D(xp+16,yp+4),ol::Vec2D(xp+16,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+16,yp+4),ol::Vec2D(xp+6,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+10),ol::Vec2D(xp+16,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+4,yp+4),ol::Vec2D(xp+4,yp+16)).Draw(CouleurLigne);
...
{
ol::Rect GeneralLoop(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
GeneralLoop.SetRoundness(4);
GeneralLoop.DrawOutline(CouleurLigne);
if(state==1){ol::Circle(ol::Vec2D(xp+10,yp+10),5).Draw(CouleurFader);}
ol::Circle(ol::Vec2D(xp+10,yp+10),5).DrawOutline(CouleurLigne);
...
ol::Line(ol::Vec2D(xp+4,yp+4),ol::Vec2D(xp+4,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+4),ol::Vec2D(xp+6,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+8,yp+4),ol::Vec2D(xp+8,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+10,yp+4),ol::Vec2D(xp+10,yp+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+10,yp+4),ol::Vec2D(xp+20,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+10,yp+16),ol::Vec2D(xp+20,yp+10)).Draw(CouleurLigne);
if(mouse_x>xp && mouse_x<xp+20 && mouse_y>yp && mouse_y<yp+20)
{
if(Midi_Faders_Affectation_Type!=0)//config midi
{
...
{
ol::Rect Autolch(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
Autolch.SetRoundness(4);
if(state==1){Autolch.Draw(CouleurFader);}

Autolch.DrawOutline(CouleurLigne);

ol::Line(ol::Vec2D(xp+5,yp+15),ol::Vec2D(xp+15,yp+5)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+15,yp+5),ol::Vec2D(xp+10,yp+5)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+15,yp+5),ol::Vec2D(xp+15,yp+10)).Draw(CouleurLigne);
...
{
ol::Rect NeXtbutt(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
...
{
ol::Rect PreVbutt(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
...
{
ol::Rect MoinsC(ol::Vec2D(xp,yp),ol::Vec2D(15,15));
...
{
ol::Rect PlusC(ol::Vec2D(xp,yp),ol::Vec2D(15,15));
...
{
ol::Rect toggling_B(ol::Vec2D(xp,yp),ol::Vec2D(70,20));
...
{
ol::Rect pulse_B(ol::Vec2D(xp,yp),ol::Vec2D(30,20));
...
ol::Circle BMidiRaccroche(Xb+largeur+10,Yb+hauteur+5, 6);//raccroche midi
if(is_raccrochage_midi_remote[IDmidi]==1)
{
BMidiRaccroche.Draw(CouleurFader);
//affichage niveau
ol::Line MonNiveauMidi(ol::Vec2D(Xb,(Yb+hauteur) -(val_raccrochage_midi[IDmidi]*2)),ol::Vec2D(Xb+largeur+10,(Yb+hauteur) - (val_raccrochage_midi[IDmidi]*2)));
MonNiveauMidi.SetLineWidth(epaisseur_ligne_fader);
MonNiveauMidi.Draw(CouleurLigne);

ol::Line MaJonction(ol::Vec2D(Xb+largeur+10,(Yb+hauteur)),ol::Vec2D(Xb+largeur+10,(Yb+hauteur) - (val_raccrochage_midi[IDmidi]*2)));
...
BMidiRaccroche.Draw(CouleurFader);
//affichage niveau
ol::Line MonNiveauMidi(ol::Vec2D(Xb,Yb+(val_raccrochage_midi[IDmidi]*2)),ol::Vec2D(Xb+largeur+10,Yb+(val_raccrochage_midi[IDmidi]*2)));
MonNiveauMidi.SetLineWidth(epaisseur_ligne_fader);
MonNiveauMidi.Draw(CouleurLigne);

ol::Line MaJonction(ol::Vec2D(Xb+largeur+10,Yb+hauteur),ol::Vec2D(Xb+largeur+10,Yb+(val_raccrochage_midi[IDmidi]*2)));
MaJonction.SetLineWidth(epaisseur_ligne_fader);
MaJonction.Draw(CouleurFond,CouleurLigne);
...
ol::Circle BMidiRaccroche(Xb+largeur+10,Yb+hauteur+5, 4);//raccroche midi
if(is_raccrochage_midi_remote[IDmidi]==1)
{
BMidiRaccroche.Draw(CouleurFader);
//affichage niveau
ol::Line MonNiveauMidi(ol::Vec2D(Xb,(Yb+hauteur) -val_raccrochage_midi[IDmidi]),ol::Vec2D(Xb+largeur+10,(Yb+hauteur) - val_raccrochage_midi[IDmidi]));
MonNiveauMidi.SetLineWidth(epaisseur_ligne_fader);
MonNiveauMidi.Draw(CouleurLigne);

ol::Line MaJonction(ol::Vec2D(Xb+largeur+10,(Yb+hauteur)),ol::Vec2D(Xb+largeur+10,(Yb+hauteur) - val_raccrochage_midi[IDmidi]));
MaJonction.SetLineWidth(epaisseur_ligne_fader);
...
ol::Circle BMidiRaccroche(Xb+largeur+10,Yb+hauteur+15, 3);//raccroche midi
if(is_raccrochage_midi_remote[IDmidi]==1)
{

//affichage niveau
ol::Line MonNiveauMidi(ol::Vec2D(Xb+val_raccrochage_midi[IDmidi],Yb ),ol::Vec2D(Xb+val_raccrochage_midi[IDmidi],(Yb+hauteur)+15 ));
MonNiveauMidi.SetLineWidth(epaisseur_ligne_fader);
MonNiveauMidi.Draw(CouleurLigne);

ol::Line MaJonction(ol::Vec2D(Xb+val_raccrochage_midi[IDmidi],(Yb+hauteur)+15),ol::Vec2D(Xb+largeur+7,(Yb+hauteur)+15));
MaJonction.SetLineWidth(epaisseur_ligne_fader);
...
ol::Circle BMidiRaccroche(Xb+largeur+10,Yb+hauteur+15, 6);//raccroche midi
if(is_raccrochage_midi_remote[IDmidi]==1)
{
...
ol::Line MaJonction(ol::Vec2D(Xb+val_raccrochage_midi[IDmidi],(Yb+hauteur)+15),ol::Vec2D(Xb+largeur+4,(Yb+hauteur)+15));
MaJonction.SetLineWidth(epaisseur_ligne_fader);
...
ol::Circle BMidiRaccroche(Xb+largeur+10,Yb+hauteur+15, 4);//raccroche midi
if(is_raccrochage_midi_remote[IDmidi]==1)
{
...
ol::Line MaJonction(ol::Vec2D(Xb+val_raccrochage_midi[IDmidi],(Yb+hauteur)+15),ol::Vec2D(Xb+largeur+6,(Yb+hauteur)+15));
MaJonction.SetLineWidth(epaisseur_ligne_fader);
MaJonction.Draw(CouleurLigne,CouleurFond);
BMidiRaccroche.Draw(CouleurFader);
}
...
ol::Circle BMidiRaccroche(Xb+largeur,Yb+hauteur+15, 6);//raccroche midi
if(is_raccrochage_midi_remote[IDmidi]==1)
{
BMidiRaccroche.Draw(CouleurFader);
//affichage niveau
...
ol::Circle monCurseurHue( ol::Vec2D(tmp_position_curseur_hue_x, tmp_position_curseur_hue_y), 10 );
monCurseurHue.Draw( CouleurFond );
ol::Line MonNiveauMidi(ol::Vec2D(Xb+largeur-6,Yb+hauteur+15 ),ol::Vec2D(tmp_position_curseur_hue_x,Yb+hauteur+15 ));
MonNiveauMidi.SetLineWidth(epaisseur_ligne_fader);
MonNiveauMidi.Draw(CouleurFond,CouleurLigne);

ol::Line MaJonction(ol::Vec2D(tmp_position_curseur_hue_x,Yb+hauteur+15),ol::Vec2D(tmp_position_curseur_hue_x,tmp_position_curseur_hue_y));
MaJonction.SetLineWidth(epaisseur_ligne_fader);
MaJonction.Draw(CouleurLigne,CouleurFond);
...
{
ol::Rect MidiMute_B(ol::Vec2D(Xb,Yb),ol::Vec2D(60,20));
...
{
ol::Rect Command(ol::Vec2D(xcom,ycom),ol::Vec2D(65,20));
