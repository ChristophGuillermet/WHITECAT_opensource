...
//background window
ol::Rect TimeWindow(ol::Vec2D(xtime, ytime ), ol::Vec2D( 370,300));
...
/////////////////////////////////////////////////////////////////////////////////
ol::Circle monTrajetTime0( ol::Vec2D(xtime+150, ytime+150), 115);
 monTrajetTime0.SetLineWidth(epaisseur_ligne_fader);
 monTrajetTime0.DrawOutline( CouleurBleuProcedure);

ol::Circle monTrajetTime2( ol::Vec2D(xtime+150, ytime+150), 85);
...
if( Midi_Faders_Affectation_Type!=0 && window_focus_id==W_TIME)
{
 ...
 ol::Circle monCurseurTime( ol::Vec2D(position_curseur_time_x-4, position_curseur_time_y-4), 8 );
...
ol::Rect SetTimeWheelMode(ol::Vec2D(xtime+120,ytime+80),ol::Vec2D(60,20));
...
ol::Line(ol::Vec2D(xtime+150,ytime+100),ol::Vec2D(ol::Vec2D(xtime+150,ytime+115))).Draw(CouleurLigne);
if(time_wheel_datatype_is==0)//minutes
{
ol::Line(ol::Vec2D(xtime+150,ytime+115),ol::Vec2D(ol::Vec2D(xtime+100,ytime+115))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xtime+100,ytime+115),ol::Vec2D(ol::Vec2D(xtime+100,ytime+120))).Draw(CouleurLigne);
...
{
ol::Line(ol::Vec2D(xtime+150,ytime+115),ol::Vec2D(ol::Vec2D(xtime+160,ytime+115))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xtime+160,ytime+115),ol::Vec2D(ol::Vec2D(xtime+160,ytime+120))).Draw(CouleurLigne);
petitchiffrerouge.Print("sec",xtime+150,ytime+135);
petitchiffre.Print("SEC.",xtime+135,ytime+95);
}
if(time_wheel_datatype_is==2)//1/10
{
ol::Line(ol::Vec2D(xtime+150,ytime+115),ol::Vec2D(ol::Vec2D(xtime+200,ytime+115))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xtime+200,ytime+115),ol::Vec2D(ol::Vec2D(xtime+200,ytime+120))).Draw(CouleurLigne);
...
//////////////////////////CHRONO//////////////////////////////////////////////////
ol::Circle DoChrono( ol::Vec2D(xtime+140, ytime+190), 15);
DoChrono.SetLineWidth(epaisseur_ligne_fader);
DoChrono.Draw(CouleurBleuProcedure.WithAlpha(0.4));

ol::Circle ResetChrono( ol::Vec2D(xtime+180, ytime+200), 8);
...
ol::Rect SetTimeIn(ol::Vec2D(xtime+300,ytime+20),ol::Vec2D(50,30));
SetTimeIn.SetRoundness(7.5);
SetTimeIn.SetLineWidth(epaisseur_ligne_fader);

ol::Rect SetTimeOut(ol::Vec2D(xtime+300,ytime+70),ol::Vec2D(50,30));
SetTimeOut.SetRoundness(7.5);
SetTimeOut.SetLineWidth(epaisseur_ligne_fader);

ol::Rect SetTimeDIn(ol::Vec2D(xtime+300,ytime+120),ol::Vec2D(50,30));
SetTimeDIn.SetRoundness(7.5);
SetTimeDIn.SetLineWidth(epaisseur_ligne_fader);

ol::Rect SetTimeDOut(ol::Vec2D(xtime+300,ytime+170),ol::Vec2D(50,30));
...
////////////TAP TEMPO/////////////////////////////////////////////////////////
ol::Rect TapTempo(ol::Vec2D(xtime+310,ytime+210),ol::Vec2D(40,30));
...
ol::Rect RecTempo(ol::Vec2D(xtime+285,ytime+210),ol::Vec2D(15,15));
...
ol::Rect TapSend(ol::Vec2D(xtime+265,ytime+210),ol::Vec2D(15,15));
...
///////////AFFECT TIME////////////////////////////////////////////////////////
ol::Rect TimeAffect(ol::Vec2D(xtime+280,ytime+260),ol::Vec2D(70,30));
...
ol::Line (ol::Vec2D( xtime+231,ytime+231),ol::Vec2D( xtime+245,ytime+245)).Draw(CouleurLigne);
