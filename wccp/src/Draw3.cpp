...
ol::Rect Aera(ol::Vec2D(xw,yw),ol::Vec2D(draw_tracking_aera_size_x,draw_tracking_aera_size_y));
Aera.SetLineWidth(2.0);
Aera.SetRoundness(4);
Aera.Draw(CouleurBleuProcedure.WithAlpha(0.1));

ol::Rect Level(ol::Vec2D(xw,yw),ol::Vec2D(draw_largeur_case[draw_preset_selected],draw_hauteur_case[draw_preset_selected]));

int ind=0;
for(int col=0;col<draw_preset_parameters[draw_preset_selected][0];col++)
{
ol::Line(ol::Vec2D(xw+(col*draw_largeur_case[draw_preset_selected]),yw),ol::Vec2D(xw+(col*draw_largeur_case[draw_preset_selected]),yw+(draw_preset_parameters[draw_preset_selected][1]*draw_hauteur_case[draw_preset_selected]))).Draw(CouleurFond.WithAlpha(0.5));

for(int lig=0;lig<draw_preset_parameters[draw_preset_selected][1];lig++)
{
ol::Line(ol::Vec2D(xw,yw+(lig*draw_hauteur_case[draw_preset_selected])),ol::Vec2D(xw+(draw_preset_parameters[draw_preset_selected][0]*draw_largeur_case[draw_preset_selected]),yw+(lig*draw_hauteur_case[draw_preset_selected]))).Draw(CouleurFond.WithAlpha(0.5));

ind=col+(lig*draw_preset_parameters[draw_preset_selected][0]);
Level.MoveTo(ol::Vec2D(xw+(col*draw_largeur_case[draw_preset_selected]),yw+(lig*draw_hauteur_case[draw_preset_selected])));
...
ol::Rect Curseur(ol::Vec2D(xw+draw_centre_x[draw_preset_selected]*draw_largeur_case[draw_preset_selected],yw+draw_centre_y[draw_preset_selected]*draw_hauteur_case[draw_preset_selected]),
ol::Vec2D(draw_largeur_case[draw_preset_selected], draw_hauteur_case[draw_preset_selected]  ));
...
{
ol::Rect DrawBckgd(ol::Vec2D(xw,  yw), ol::Vec2D( draw_window_x_size,draw_window_y_size));
...
//SHAPE
ol::Rect DrawBrush(ol::Vec2D(xw+180,  yw+12), ol::Vec2D( 50,20));
...
ol::Rect Ppoint(ol::Vec2D(xw+202,yw+21),ol::Vec2D(3,3));
...
//SELECTION PRESETS
ol::Rect DrawPst(ol::Vec2D(xw,  yw), ol::Vec2D( 50,20));
DrawPst.SetRoundness(5);
for(int pr=0;pr<6;pr++)
{
DrawPst.MoveTo(ol::Vec2D(xw+240+(pr*58),yw+12));
...
ol::Rect DrawingMode(ol::Vec2D(xw+20,yw+60),ol::Vec2D(60,20));
...
ol::Rect FrameLevelPressure(ol::Vec2D(xw+180,yw+45),ol::Vec2D(127,10));
ol::Rect LevelPressure(ol::Vec2D(xw+180,yw+45),ol::Vec2D(127*draw_level_to_do[draw_preset_selected],10));
...
ol::Circle BMidiOutPressure(xw+316,yw+62, 5);
...
ol::Rect FrameLevelTilt(ol::Vec2D(xw+180,yw+70),ol::Vec2D(127,10));
ol::Rect LevelTilt(ol::Vec2D(xw+180,yw+70),ol::Vec2D(127*draw_tilt_to_do[draw_preset_selected],10));
...
ol::Circle BMidiOutTilt(xw+316,yw+87, 5);
...
ol::Rect FrameGhostSize(ol::Vec2D(xw+180,yw+95),ol::Vec2D(127,10));
ol::Rect GhostSize(ol::Vec2D(xw+180,yw+95),ol::Vec2D(127*draw_ghost_to_do[draw_preset_selected],10));
...
ol::Circle BMidiOutSize(xw+316,yw+112, 5);
...
ol::Rect ClearBoard(ol::Vec2D(xw+400,yw+40), ol::Vec2D(110,20));
...
ol::Rect AffectMode(ol::Vec2D(xw+400,yw+75), ol::Vec2D(110,20));
...
ol::Rect Affecttodock(ol::Vec2D(xw+400,yw+100), ol::Vec2D(110,20));
...
//////////////EDIT MODE///////////////////////////////
ol::Rect GriderEditEnable( ol::Vec2D((xw+530),(yw+40)),ol::Vec2D(50,20));
...
ol::Rect BackGriderCol(ol::Vec2D(xw+550,yw+75),ol::Vec2D(30,20));
...
ol::Rect BackGriderRow(ol::Vec2D(xw+550,yw+100),ol::Vec2D(30,20));
...
ol::Rect MidiX(ol::Vec2D(xw+65,yw+580),ol::Vec2D(127,10));
ol::Rect MidiXLev(ol::Vec2D(xw+65,yw+580),ol::Vec2D(midi_levels[1660],10));
...
ol::Rect MidiY(ol::Vec2D(xw+245,yw+580),ol::Vec2D(127,10));
ol::Rect MidiYLev(ol::Vec2D(xw+245,yw+580),ol::Vec2D(midi_levels[1661],10));
...
ol::Rect NumGPL(ol::Vec2D(xw+455,yw+578),ol::Vec2D(30,18));
...
ol::Rect OffsetGPL(ol::Vec2D(xw+550,yw+578),ol::Vec2D(35,18));
