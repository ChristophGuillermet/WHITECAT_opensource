...
{
ol::Bitmap MySnapshot( SCREEN_W, SCREEN_H);
...
ol::Bitmap MySnapshot(thesix , thesiy);
...
//entree rotation ol::Rect OverRot(ol::Vec2D(plotx+76,ploty+22),ol::Vec2D(60,15));
...
ol::Rgba TmpPlotColor (Color_plotfill,Color_plotfill,Color_plotfill);
