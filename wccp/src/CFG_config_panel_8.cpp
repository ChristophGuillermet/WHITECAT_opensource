...
ol::Rect OverKey(ol::Vec2D(x_cfg,y_cfg),ol::Vec2D(60,20));
OverKey.SetRoundness(1.8);
ol::Rect Function(ol::Vec2D(x_cfg,y_cfg),ol::Vec2D(120,20));
Function.SetRoundness(1.8);
ol::Rect Param(ol::Vec2D(x_cfg,y_cfg),ol::Vec2D(30,20));
Param.SetRoundness(1.8);
for(int i=0;i<10;i++)
{
OverKey.MoveTo(ol::Vec2D(x_cfg,y_cfg+15+(i*25)));
OverKey.Draw(CouleurGreen.WithAlpha(0.5));
Function.MoveTo(ol::Vec2D(x_cfg+75,y_cfg+15+(i*25)));
Function.Draw(CouleurBlind.WithAlpha(0.5));
Param.MoveTo(ol::Vec2D(x_cfg+205,y_cfg+15+(i*25)));
...
ol::Line(ol::Vec2D(cfgnetw_X,cfgnetw_Y+5),ol::Vec2D(cfgnetw_X+90,cfgnetw_Y+5)).Draw(CouleurLigne);
...
{
ol::Rect keyParam(ol::Vec2D(cfgnetw_X+60,cfgnetw_Y+25+(oi*30)),ol::Vec2D(50,25));
...
ol::Line(ol::Vec2D( x_cfg_sc+15, y_cfg_sc+50),ol::Vec2D( x_cfg_sc+120, y_cfg_sc+50)).Draw(CouleurLigne);
...
for (int l=0;l<7;l++)
{
ol::Rect Param(ol::Vec2D(x_cfg_sc+120,y_cfg_sc+60+(l*30)),ol::Vec2D(50,25));
...
ol::Line(ol::Vec2D( x_cfg_sc+200, y_cfg_sc+50),ol::Vec2D( x_cfg_sc+305, y_cfg_sc+50)).Draw(CouleurLigne);
char tmp_state_core[8];
for (int l=0;l<9;l++)
{
ol::Rect BParam(ol::Vec2D(x_cfg_sc+300,y_cfg_sc+60+(l*25)),ol::Vec2D(50,20));
...
ol::Line(ol::Vec2D( x_cfg_sc+370, y_cfg_sc+50),ol::Vec2D( x_cfg_sc+485, y_cfg_sc+50)).Draw(CouleurLigne);
for (int l=0;l<2;l++)
{
ol::Rect BCParam(ol::Vec2D(x_cfg_sc+470,y_cfg_sc+60+(l*30)),ol::Vec2D(50,25));
...
int Box_artnet_udpport(int macx, int macy)
{
   ...
   ol::Rect UDPOut(ol::Vec2D(macx+20,macy+5),ol::Vec2D(45,25));
   UDPOut.SetRoundness(7.5);
   UDPOut.Draw(CouleurFond.WithAlpha(0.4));
   ol::Rect UDPIn(ol::Vec2D(macx+95,macy+5),ol::Vec2D(45,25));
...
ol::Canvas::SetClipping( x_cfg_sc, y_cfg_sc, largeur_cfg_sc, hauteur_cfg_sc);
...
{
ol::Rect UnderParam(ol::Vec2D(cfgnetw_X+155,cfgnetw_Y+55+(oi*30)),ol::Vec2D(50,25));
...
ol::Line(ol::Vec2D(cfgnetw_X+10,cfgnetw_Y+45),ol::Vec2D(cfgnetw_X+100,cfgnetw_Y+45)).Draw(CouleurLigne);
...
ol::Rect UnderParam(ol::Vec2D(cfgnetw_X+155,cfgnetw_Y+235),ol::Vec2D(50,25));
UnderParam.SetRoundness(7.5);
UnderParam.SetLineWidth(epaisseur_ligne_fader);
UnderParam.Draw(CouleurFond.WithAlpha(0.5));

ol::Rect UnderParam2(ol::Vec2D(cfgnetw_X+155,cfgnetw_Y+265),ol::Vec2D(50,20));
...
ol::Line(ol::Vec2D(cfgnetw_X+10,cfgnetw_Y+225),ol::Vec2D(cfgnetw_X+100,cfgnetw_Y+225)).Draw(CouleurLigne);
...
{
ol::Rect UnderParam(ol::Vec2D(cfgnetw_X+365,cfgnetw_Y+55+(oi*30)),ol::Vec2D(50,25));
UnderParam.SetRoundness(7.5);
UnderParam.SetLineWidth(epaisseur_ligne_fader);
UnderParam.Draw(CouleurFond.WithAlpha(0.5));
...
ol::Line(ol::Vec2D(cfgnetw_X+225,cfgnetw_Y+45),ol::Vec2D(cfgnetw_X+410,cfgnetw_Y+45)).Draw(CouleurLigne);
...
ol::Line(ol::Vec2D(cfgnetw_X+430,cfgnetw_Y+45),ol::Vec2D(cfgnetw_X+530,cfgnetw_Y+45)).Draw(CouleurLigne);
petitchiffre.Print("Open Camera",cfgnetw_X+430,cfgnetw_Y+70);
ol::Rect CamOn(ol::Vec2D(cfgnetw_X+525,cfgnetw_Y+55),ol::Vec2D(50,20));
...
ol::Rect ArduinOn(ol::Vec2D(cfgnetw_X+525,cfgnetw_Y+85),ol::Vec2D(50,20));
...
ol::Rect iCatOn(ol::Vec2D(cfgnetw_X+525,cfgnetw_Y+115),ol::Vec2D(50,20));
...
ol::Rect ProcessB(ol::Vec2D(cfgnetw_X+525,cfgnetw_Y+190),ol::Vec2D(50,20));
...
ol::Rect ProcessCorB(ol::Vec2D(cfgnetw_X+525,cfgnetw_Y+215),ol::Vec2D(50,20));
...
ol::Line(ol::Vec2D(cfgnetw_X+430,cfgnetw_Y+210),ol::Vec2D(cfgnetw_X+500,cfgnetw_Y+210)).Draw(CouleurLigne);
...
ol::Rect faderSpace(ol::Vec2D(cfgnetw_X+525,cfgnetw_Y+265),ol::Vec2D(50,20));
...
ol::Line(ol::Vec2D(cfgnetw_X+430,cfgnetw_Y+260),ol::Vec2D(cfgnetw_X+560,cfgnetw_Y+260)).Draw(CouleurLigne);
...
ol::Rect ExpertB(ol::Vec2D(cfgnetw_X+740,cfgnetw_Y+225),ol::Vec2D(50,20));
...
{
ol::Rect MonCallButton(ol::Vec2D(callb_x,callb_y),ol::Vec2D(100,30));
...
ol::Rect DeviceArtNetDevice( ol::Vec2D((cfgdmx_X+10),(cfgdmx_Y+50)),ol::Vec2D(180,30));
DeviceArtNetDevice.SetRoundness(15);

ol::Rect DeviceEnttecOpen( ol::Vec2D((cfgdmx_X+10),(cfgdmx_Y+80)),ol::Vec2D(180,30));
DeviceEnttecOpen.SetRoundness(15);

ol::Rect DeviceEnttecPro( ol::Vec2D((cfgdmx_X+10),(cfgdmx_Y+110)),ol::Vec2D(180,30));
DeviceEnttecPro.SetRoundness(15);


ol::Rect DeviceSunlite ( ol::Vec2D((cfgdmx_X+10),(cfgdmx_Y+170)),ol::Vec2D(180,30));
DeviceSunlite.SetRoundness(15);


//definition des aires univers
ol::Rect ArtNetSendUniverse( ol::Vec2D((cfgdmx_X+220),(cfgdmx_Y+50)),ol::Vec2D(70,30));
ArtNetSendUniverse.SetRoundness(15);

//definition des aire d edition d adresse
ol::Rect ArtNetSendAdress( ol::Vec2D((cfgdmx_X+320),(cfgdmx_Y+50)),ol::Vec2D(170,30));
ArtNetSendAdress.SetRoundness(15);

//SPEC. ARTNET: BROADCAST MODE
ol::Rect ArtNetBroadcastMode( ol::Vec2D((cfgdmx_X+520),(cfgdmx_Y+50)),ol::Vec2D(130,30));
ArtNetBroadcastMode.SetRoundness(15);

//SPEC ARTNET ARTPOLL
ol::Rect ArtNetPollforDevices( ol::Vec2D((cfgdmx_X+670),(cfgdmx_Y+50)),ol::Vec2D(100,30));
ArtNetPollforDevices.SetRoundness(15);

//SPEC ARTNET DOUBLE DMX
ol::Rect ArtNetDoubleDMX( ol::Vec2D((cfgdmx_X+770),(cfgdmx_Y+50)),ol::Vec2D(60,30));
ArtNetDoubleDMX.SetRoundness(15);



//SPEC ENTTEC PROIN
ol::Rect EnttecProIN( ol::Vec2D((cfgdmx_X+240),(cfgdmx_Y+110)),ol::Vec2D(170,30));
EnttecProIN.SetRoundness(15);



//SPEC SUNLITE
ol::Rect SunliteAllowsIN( ol::Vec2D((cfgdmx_X+240),(cfgdmx_Y+170)),ol::Vec2D(150,30));
...
ol::Rect DmxFeedbackZone(ol::Vec2D((cfgdmx_X+10), (cfgdmx_Y+265)),ol::Vec2D(560,25));
...
ol::Rect ConfigPanel(ol::Vec2D(cfg_X,  cfg_Y), ol::Vec2D( largeurCFGwindow,hauteurCFGwindow));
...
{
ol::Rect SaveCFG( ol::Vec2D((cfg_X+largeurCFGwindow-110),(cfg_Y+hauteurCFGwindow-40)),ol::Vec2D(90,30));
...
{
ol::Rect CadreGeneralConfig(ol::Vec2D(window_cfgX,window_cfgY),ol::Vec2D(largeurCFGwindow,hauteurCFGwindow+40));
...
{
ol::Rect MySetup(ol::Vec2D( mysetupx+(choix*100), window_cfgY+5),ol::Vec2D(90,40));
