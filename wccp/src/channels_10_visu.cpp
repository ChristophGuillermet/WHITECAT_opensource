...
{
ol::Line( ol::Vec2D( ScrollX, ScrollY ), ol::Vec2D( ScrollX,ScrollY+250)).Draw( CouleurLigne );
...
{
ol::Line( ol::Vec2D(ScrollX,ScrollY+positiony), ol::Vec2D( ScrollX+5,ScrollY+positiony)).Draw( CouleurLigne );
...
break;
case 1:
ol::Line( ol::Vec2D(ScrollX,ScrollY), ol::Vec2D( ScrollX+10,ScrollY)).Draw( CouleurLigne );
petitpetitchiffre.Print( "  1 -48" ,ScrollX+25,ScrollY );
ol::Line( ol::Vec2D(ScrollX,ScrollY+25), ol::Vec2D( ScrollX+10,ScrollY+25)).Draw( CouleurLigne );
petitpetitchiffre.Print( " 49 -96" ,ScrollX+25,ScrollY+25 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+50), ol::Vec2D( ScrollX+10,ScrollY+50)).Draw( CouleurLigne );
petitpetitchiffre.Print( " 97-144" ,ScrollX+25,ScrollY+50 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+75), ol::Vec2D( ScrollX+10,ScrollY+75)).Draw( CouleurLigne );
petitpetitchiffre.Print( "145-192" ,ScrollX+25,ScrollY+75 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+100), ol::Vec2D( ScrollX+10,ScrollY+100)).Draw( CouleurLigne );
petitpetitchiffre.Print( "193-240" ,ScrollX+25,ScrollY+100 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+125), ol::Vec2D( ScrollX+10,ScrollY+125)).Draw( CouleurLigne );
petitpetitchiffre.Print( "241-288" ,ScrollX+25,ScrollY+125 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+150), ol::Vec2D( ScrollX+10,ScrollY+150)).Draw( CouleurLigne );
petitpetitchiffre.Print( "289-336" ,ScrollX+25,ScrollY+150 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+175), ol::Vec2D( ScrollX+10,ScrollY+175)).Draw( CouleurLigne );
petitpetitchiffre.Print( "337-384" ,ScrollX+25,ScrollY+175 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+200), ol::Vec2D( ScrollX+10,ScrollY+200)).Draw( CouleurLigne );
petitpetitchiffre.Print( "385-432" ,ScrollX+25,ScrollY+200 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+225), ol::Vec2D( ScrollX+10,ScrollY+225)).Draw( CouleurLigne );
petitpetitchiffre.Print( "433-480" ,ScrollX+25,ScrollY+225 );
ol::Line( ol::Vec2D(ScrollX,ScrollY+250), ol::Vec2D( ScrollX+10,ScrollY+250)).Draw( CouleurLigne );
petitpetitchiffre.Print( "  ->512" ,ScrollX+25,ScrollY+250 );
break;
}

ol::Rect Curseur_ScrollChannel(ol::Vec2D(ScrollX-10,ScrollY+scroll_channelspace-10),ol::Vec2D(100,20));
...
ol::Rect ChannelRect(ol::Vec2D(xchan,ypos_l),ol::Vec2D(40,65));
ChannelRect.SetRoundness(10);
ChannelRect.SetLineWidth(epaisseur_ligne_fader);
ol::Rect LevelOverdock(ol::Vec2D(xchan,ypos_l),ol::Vec2D(35,13));
ol::Rect LevelOverTrack(ol::Vec2D(xchan,ypos_l),ol::Vec2D(35,13));
ol::Rect LevelModified(ol::Vec2D(xchan,ypos_l),ol::Vec2D(20,13));
...
ChannelRect.MoveTo(ol::Vec2D(((xchan-5) + (xposch)),((ypos_l)+ 40 -ypos_ch)));
...
petitchiffre.Print(chan_is ,(xchan + (xposch)),((ypos_l) + 50 -ypos_ch ),ol::CENTER);
}
else if(c>=100)
{
sprintf(chan_is,"%d",num_circ);
petitchiffre.Print(chan_is ,((xchan + (xposch))-5),((ypos_l) + 50 - ypos_ch ),ol::CENTER);
}
...
{
case 1:
petitpetitchiffre.Print("+", (xchan + 15+(xposch)),((ypos_l) + 70 -ypos_ch),ol::RIGHT );
break;
case 2:
petitpetitchiffre.Print("-", (xchan + 15+(xposch)),((ypos_l) + 70 -ypos_ch),ol::RIGHT );
break;
...
LevelOverdock.MoveTo(ol::Vec2D(((xchan-5) + (xposch))+15,((ypos_l)+ 92 - ypos_ch)));
...
{
petitdoomInspekt.Print(ol::ToString(highest_level_comes_from_fader[num_circ]) ,((xchan + (xposch))+15),((ypos_l) + 72 - ypos_ch),ol::CENTER);
}
if(i_m_over_a_track==1 && over_track_show_channel[num_circ]>0)
{
ChannelRect.DrawOutline(CouleurGreen);
LevelOverTrack.MoveTo(ol::Vec2D(((xchan-5) + (xposch))-15,((ypos_l)+ 92 - ypos_ch)));
...
case 0:
if(circuittoshow>0)
{circuitlevel.Print(ol::ToString((int) (((float)(circuittoshow) /2.55))) ,(xchan + (xposch)),((ypos_l) + 80 - ypos_ch),ol::CENTER ); }
//
if(bufferFaders[num_circ]>0)
{circuitfaderlevel.Print(ol::ToString((int) (((float)(bufferFaders[num_circ]) /2.55))) ,(xchan + (xposch)),((ypos_l) + 90 - ypos_ch),ol::CENTER );}
//blind
if( index_blind==1 && bufferBlind[num_circ]>0)
{circuitblindlevel.Print(ol::ToString((int) (((float)(bufferBlind[num_circ]) /2.55))) ,(xchan + (xposch)),((ypos_l) + 100 - ypos_ch),ol::CENTER );}
//affichage niveau inspekt fader
if(index_inspekt==1 && show_who_is_in_FADER_DOCK[num_circ]==1)
{petitpetitchiffre.Print(ol::ToString((int)(((float)(FaderDockContains[over_fader][over_dock][num_circ]) /2.55))) ,(xchan + (xposch))+15,((ypos_l) + 100 -ypos_ch),ol::CENTER );}
//inspekt track
if(index_inspekt==1 && i_m_over_a_track==1 && over_track_show_channel[num_circ]>0)
{petitpetitchiffre.Print(ol::ToString((int)(float(over_track_show_channel[num_circ]) /2.55)) ,(xchan + (xposch))-15,((ypos_l) + 100 -ypos_ch),ol::CENTER );}
...
{
ChannelRect.Draw(CouleurBlind.WithAlpha(alpha_blinker));
petitchiffre.Print(ol::ToString((int) (((float)(freeze_state[num_circ]) /2.55))) ,(xchan + (xposch))+10,((ypos_l) + 70 - ypos_ch),ol::CENTER );
}
...
case 1:
if(circuittoshow>0)
{circuitlevel.Print(ol::ToString((int)circuittoshow) ,(xchan + (xposch)),((ypos_l) + 80 - ypos_ch),ol::CENTER ); }
if(bufferFaders[num_circ]>0)
{circuitfaderlevel.Print(ol::ToString((int)(bufferFaders[num_circ])) ,(xchan + (xposch)),((ypos_l) + 90 - ypos_ch),ol::CENTER ); }
//blind
if(index_blind==1 && bufferBlind[num_circ]>0 )
{circuitblindlevel.Print(ol::ToString((int)(bufferBlind[num_circ])) ,(xchan + (xposch)),((ypos_l) + 100 - ypos_ch),ol::CENTER ); }
//affichage niveau inspekt fader
if(index_inspekt==1 && show_who_is_in_FADER_DOCK[num_circ]==1)
{petitpetitchiffre.Print(ol::ToString((int)(FaderDockContains[over_fader][over_dock][num_circ])) ,(xchan + (xposch))+15,((ypos_l) + 100 -ypos_ch),ol::CENTER );}
//inspekt track
if(index_inspekt==1 && i_m_over_a_track==1)
{petitpetitchiffre.Print(ol::ToString(over_track_show_channel[num_circ]) ,(xchan + (xposch))-15,((ypos_l) + 100 -ypos_ch),ol::CENTER );}
...
{
ChannelRect.Draw(CouleurBlind.WithAlpha(alpha_blinker));
petitchiffre.Print(ol::ToString((int)(freeze_state[num_circ])) ,(xchan + (xposch))+10,((ypos_l) + 70 - ypos_ch),ol::CENTER );
}
break;
}
...
{
LevelModified.MoveTo(ol::Vec2D(xchan+xposch+20,((ypos_l)+ 70 - ypos_ch)));
LevelModified.Draw(CouleurBlind);
switch (dmx_view)
{
//affichage %
case 0:
petitpetitchiffre.Print(ol::ToString((int) (((float)(channel_level_mofification_while_crossfade[num_circ]) /2.55))),(xchan + xposch+25),((ypos_l) + 80 - ypos_ch),ol::RIGHT );
break;
case 1:
petitpetitchiffre.Print(ol::ToString(channel_level_mofification_while_crossfade[num_circ]),(xchan + xposch+25),((ypos_l) + 80 - ypos_ch),ol::RIGHT );
break;
}
}
...
int Draw_Channel_Preset_Title(int xchan, int ychan, int prst_v)
{
 ...
 ol::Rect Background_title(ol::Vec2D(xchan+40,ychan),ol::Vec2D(210,20));
 ...
 ol::Line(ol::Vec2D(xchan,ychan+25),ol::Vec2D(xchan+600,ychan+25)).Draw(CouleurLigne);


 ol::Rect Build(ol::Vec2D(xchan+520,ychan),ol::Vec2D(55,20));
 Build.SetRoundness(3);

if(prst_v!=0)//pas la vue patchée
{
 ol::Rect M(ol::Vec2D(xchan+435,ychan),ol::Vec2D(20,20));
 M.SetRoundness(3);
 ol::Rect F(ol::Vec2D(xchan+460,ychan),ol::Vec2D(20,20));
 F.SetRoundness(3);
...
break;
 ...
 ol::Rect All(ol::Vec2D(xchan+485,ychan),ol::Vec2D(30,20));
 All.SetRoundness(3);
...
ol::Rect ChannelRect(ol::Vec2D(xchan, ypos_ch),ol::Vec2D(40,65));
ChannelRect.SetRoundness(10);
ChannelRect.SetLineWidth(epaisseur_ligne_fader);
ol::Rect LevelOverdock(ol::Vec2D(xchan, ypos_ch),ol::Vec2D(35,13));
ol::Rect LevelOverTrack(ol::Vec2D(xchan,ypos_ch),ol::Vec2D(35,13));
ol::Rect LevelModified(ol::Vec2D(xchan,ypos_ch),ol::Vec2D(20,13));
...
ChannelRect.MoveTo(ol::Vec2D(((xchan-5) + (xposch)), ypos_ch));
...
{
sprintf(chan_is," %d",num_circ);
petitchiffre.Print(chan_is ,(xchan + (xposch)),ypos_ch +10,ol::CENTER);
}
else if(c>=100)
{
sprintf(chan_is,"%d",num_circ);
petitchiffre.Print(chan_is ,((xchan + (xposch))-5),ypos_ch +10,ol::CENTER);
}
...
{
case 1:
petitpetitchiffre.Print("+", (xchan + 15+(xposch)),ypos_ch+30,ol::RIGHT );
break;
case 2:
petitpetitchiffre.Print("-", (xchan + 15+(xposch)),ypos_ch+30,ol::RIGHT );
break;
...
ChannelRect.DrawOutline(CouleurFader);
//affichage du niveau du dock survolé
LevelOverdock.MoveTo(ol::Vec2D(((xchan-5) + (xposch))+15, ypos_ch+52));
LevelOverdock.Draw(CouleurFader);
}
//affichage du master  qui envoie le plus haut niveau au circuit
if(highest_level_comes_from_fader[num_circ]>0)//si le highest level exist : valeur faders de 1 à 48 quand attribué
{
petitdoomInspekt.Print(ol::ToString(highest_level_comes_from_fader[num_circ]) ,((xchan + (xposch))+15),ypos_ch+32,ol::CENTER);
}
if(i_m_over_a_track==1 && over_track_show_channel[num_circ]>0)
{
ChannelRect.DrawOutline(CouleurGreen);
LevelOverTrack.MoveTo(ol::Vec2D(((xchan-5) + (xposch))-15,ypos_ch+52));
LevelOverTrack.Draw(CouleurGreen);
}
}
...
case 0:
if(circuittoshow>0)
{circuitlevel.Print(ol::ToString((int) (((float)(circuittoshow) /2.55))) ,(xchan + (xposch)), ypos_ch+40,ol::CENTER ); }
//
if(bufferFaders[num_circ]>0)
{circuitfaderlevel.Print(ol::ToString((int) (((float)(bufferFaders[num_circ]) /2.55))) ,(xchan + (xposch)),ypos_ch+50,ol::CENTER );}
//blind
if( index_blind==1 && bufferBlind[num_circ]>0)
{circuitblindlevel.Print(ol::ToString((int) (((float)(bufferBlind[num_circ]) /2.55))) ,(xchan + (xposch)),ypos_ch+60,ol::CENTER );}
//affichage niveau inspekt fader
if(index_inspekt==1 && show_who_is_in_FADER_DOCK[num_circ]==1)
{petitpetitchiffre.Print(ol::ToString((int)(((float)(FaderDockContains[over_fader][over_dock][num_circ]) /2.55))) ,(xchan + (xposch))+15,ypos_ch+60,ol::CENTER );}
//inspekt track
if(index_inspekt==1 && i_m_over_a_track==1 && over_track_show_channel[num_circ]>0)
{petitpetitchiffre.Print(ol::ToString((int)(float(over_track_show_channel[num_circ]) /2.55)) ,(xchan + (xposch))-15,ypos_ch+60,ol::CENTER );}
...
{
ChannelRect.Draw(CouleurBlind.WithAlpha(alpha_blinker));
petitchiffre.Print(ol::ToString((int) (((float)(freeze_state[num_circ]) /2.55))) ,(xchan + (xposch))+10, ypos_ch+30,ol::CENTER );
}
...
case 1:
if(circuittoshow>0)
{circuitlevel.Print(ol::ToString((int)circuittoshow) ,(xchan + (xposch)),ypos_ch+40,ol::CENTER ); }
if(bufferFaders[num_circ]>0)
{circuitfaderlevel.Print(ol::ToString((int)(bufferFaders[num_circ])) ,(xchan + (xposch)),ypos_ch+50,ol::CENTER ); }
//blind
if(index_blind==1 && bufferBlind[num_circ]>0 )
{circuitblindlevel.Print(ol::ToString((int)(bufferBlind[num_circ])) ,(xchan + (xposch)), ypos_ch+60,ol::CENTER ); }
//affichage niveau inspekt fader
if(index_inspekt==1 && show_who_is_in_FADER_DOCK[num_circ]==1)
{petitpetitchiffre.Print(ol::ToString((int)(FaderDockContains[over_fader][over_dock][num_circ])) ,(xchan + (xposch))+15,ypos_ch+60,ol::CENTER );}
//inspekt track
if(index_inspekt==1 && i_m_over_a_track==1)
{petitpetitchiffre.Print(ol::ToString(over_track_show_channel[num_circ]) ,(xchan + (xposch))-15,ypos_ch+60,ol::CENTER );}
...
{
ChannelRect.Draw(CouleurBlind.WithAlpha(alpha_blinker));
petitchiffre.Print(ol::ToString((int)(freeze_state[num_circ])) ,(xchan + (xposch))+10,ypos_ch+30,ol::CENTER );
}
break;
}
...
{
ChannelRect.Draw(CouleurGreen.WithAlpha(alpha_blinker));
minidoomblanc.Print("GO",(xchan + (xposch)),ypos_ch+40,ol::CENTER );
}

if(num_circ==pause_channel_is && index_go==1 && index_pause==1)
{
ChannelRect.Draw(CouleurYellow.WithAlpha(alpha_blinker));
minidoomblanc.Print("PAUSE",(xchan + (xposch))-10,ypos_ch+40,ol::CENTER );
}

//exclude from GM action
if(Channels_excluded_from_grand_master[num_circ]==1)
{
ol::Circle CircleExcluded(xchan + xposch+26, ypos_ch +11, 3);
CircleExcluded.DrawOutline(CouleurBlind);
}

if(channel_is_touched_by_fader_fx[num_circ]==1)
{
ol::Circle CircleTouchedbyFx(xchan + xposch+26, ypos_ch +20, 3);
switch(channel_is_touched_by_fader_type_fx[num_circ])
{
case 0://normal HTP
CircleTouchedbyFx.Draw(CouleurFader);
...
if(channel_level_mofification_while_crossfade[num_circ]!=0)
{
LevelModified.MoveTo(ol::Vec2D(xchan+xposch+20,ypos_ch+30));
LevelModified.Draw(CouleurBlind);
switch (dmx_view)
{
//affichage %
case 0:
petitpetitchiffre.Print(ol::ToString((int) (((float)(channel_level_mofification_while_crossfade[num_circ]) /2.55))),(xchan + xposch+25),ypos_ch+40,ol::RIGHT );
break;
case 1:
petitpetitchiffre.Print(ol::ToString(channel_level_mofification_while_crossfade[num_circ]),(xchan + xposch+25),ypos_ch+40,ol::RIGHT );
break;
}
}
...
{
ol::Rect Barre(ol::Vec2D(chx,chy),ol::Vec2D(largeur_ChannelMenu,hauteur_ChannelMenu));
Barre.Draw(CouleurFond);
neuromoyen.Print("Ch.View:",chx,chy+13);
ol::Rect Classical(ol::Vec2D(chx+70,chy+1),ol::Vec2D(60,18));
...
ol::Rect ChooseChannelView(ol::Vec2D(chx+80,chy+5),ol::Vec2D(10,10));
char tmp_hain[24];
for(int lv=0;lv<2;lv++)
{
for(int i=0;i<8;i++)
{
ChooseChannelView.MoveTo(ol::Vec2D(chx+140+(i*15),chy+1+(15*lv)));
...
//ligne fin du menu
ol::Line(ol::Vec2D(chx,chy+hauteur_ChannelMenu),ol::Vec2D(chx+largeur_ChannelMenu,chy+hauteur_ChannelMenu)).Draw(CouleurLigne);
