...
ol::Rect Allmem(ol::Vec2D((xb+270),(yb+170)), ol::Vec2D( 50,20));
...
ol::Rect Frommem(ol::Vec2D((xb+270),(yb+205)), ol::Vec2D( 50,20));
...
ol::Rect wiz_fromMem(ol::Vec2D(xb+410,yb+200), ol::Vec2D( 60,30));
...
ol::Rect wiz_toMem(ol::Vec2D(xb+410,yb+235), ol::Vec2D( 60,30));
...
ol::Rect wiz_backg(ol::Vec2D(xb,yb), ol::Vec2D( 480,420));
...
/////////////////////////////////////////////////////////
ol::Rect wiz_ch2(ol::Vec2D(xb+10,(yb+270)), ol::Vec2D( 460,100));
...
//////////////////UP DOWN LINE  BOX/////////////////////
ol::Circle LineUp(ol::Vec2D(xb+450,yb+290),12);
LineUp.Draw(CouleurFond);
ol::Circle LineDown(ol::Vec2D(xb+450,yb+350),12);
...
ol::Rect wiz_mode(ol::Vec2D(xb+105,yb+3), ol::Vec2D( 130,30));
...
{
    ol::Rect domact(ol::Vec2D((xb+20),(yb+60+(li*30))), ol::Vec2D( 50,20));
...
case 0://REBUILD
     ...
     ol::Line(ol::Vec2D( xb+270 , yb+190),ol::Vec2D( xb+370 , yb+190)).Draw(CouleurLigne);
     for(int mod=0;mod<3;mod++)
     {
     ol::Rect choose_mode_rebuild(ol::Vec2D((xb+300),(yb+200+(wizard_action_mem*30)+(mod*20))), ol::Vec2D( 30,15));
...
{
     ol::Rect act_mem(ol::Vec2D((xb+410),(yb+190)), ol::Vec2D( 60,30));
...
ol::Rect wiz_ch(ol::Vec2D(xb+10,yb+40), ol::Vec2D( 460,100));
...
ol::Circle LineUpO(ol::Vec2D(xb+450,yb+60),12);
LineUpO.Draw(CouleurFond);
ol::Circle LineDownO(ol::Vec2D(xb+450,yb+120),12);
...
{
 ol::Rect avertissement(ol::Vec2D((xb+180), yb),ol::Vec2D(300,40));
...
{
ol::Rect doact(ol::Vec2D((xb+20),(yb+150+(li*30))), ol::Vec2D( 50,20));
...
//horizontales
ol::Line(ol::Vec2D(xb+150,yb+165),ol::Vec2D(xb+220,yb+165)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xb+160,yb+195),ol::Vec2D(xb+190,yb+195)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xb+180,yb+225),ol::Vec2D(xb+220,yb+225)).Draw(CouleurLigne);
//verticales
ol::Line(ol::Vec2D(xb+220,yb+165),ol::Vec2D(xb+220,yb+180)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xb+220,yb+225),ol::Vec2D(xb+220,yb+210)).Draw(CouleurLigne);


////////////LEVEL BOX//////////////////////////////////////////////////////////

ol::Rect levlTo(ol::Vec2D((xb+190),(yb+180)), ol::Vec2D( 60,30));
...
////////////////SWAP BOX///////////////////////////////////////////////////////////
ol::Rect swap(ol::Vec2D((xb+170),(yb+240)), ol::Vec2D( 50,20));
...
ol::Rect cancelit(ol::Vec2D((xb+85),(yb+380)), ol::Vec2D( 110,30));
...
ol::Rect doit(ol::Vec2D((xb+285),(yb+380)), ol::Vec2D( 110,30));
