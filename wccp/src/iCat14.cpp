...
///////////////SLIDER EDITING///////////////////////////////////////////////////
ol::Rect Slider_M(ol::Vec2D(xed-15,yed-10),ol::Vec2D(105,20));
...
ol::Rect Slider_F(ol::Vec2D(xed+10,yed+15),ol::Vec2D(35,20));
...
ol::Rect AffectTyp(ol::Vec2D(xed-15,yed+95),ol::Vec2D(100,20));
...
ol::Rect AffectVar(ol::Vec2D(xed+40,yed+120),ol::Vec2D(45,20));
...
//Sliders DUB
ol::Rect DubB(ol::Vec2D(xed-15,yed+150),ol::Vec2D(30,15));
...
///////////////BOUTONS EDITING///////////////////////////////////////////////////
ol::Rect Button_M(ol::Vec2D(xed-15,yed-10),ol::Vec2D(105,20));
...
previous_button_view(xed-15,yed+15,0);
next_button_view(xed+50,yed+15,0);
ol::Rect button_F(ol::Vec2D(xed+10,yed+15),ol::Vec2D(35,20));
...
ol::Rect AffectAct(ol::Vec2D(xed-15,yed+125),ol::Vec2D(100,20));
...
//VARIABLE A LA SOURIS
ol::Rect AffectVar(ol::Vec2D(xed+40,yed+150),ol::Vec2D(45,20));
AffectVar.SetRoundness(5);
AffectVar.Draw(CouleurFond.WithAlpha(0.4));
...
///////////////BOUTONS EDITING///////////////////////////////////////////////////
ol::Rect String_M(ol::Vec2D(xed-15,yed-10),ol::Vec2D(105,20));
...
previous_button_view(xed-15,yed+15,0);
next_button_view(xed+50,yed+15,0);
ol::Rect string_F(ol::Vec2D(xed+10,yed+15),ol::Vec2D(35,20));
...
int Tablier_GUI_editor( int gx, int gy)
{
 ...
 //tablier d'édition
   ol::Rect InterFS(ol::Vec2D(gx,gy),ol::Vec2D(L_tablier_iCat,H_tablier_iCat));
...
{
            ol::Rect Slider_Big(ol::Vec2D(gx+iCat_pos_slider[iCatPageis][sl][0],gy+iCat_pos_slider[iCatPageis][sl][1]),
             ol::Vec2D((l_sl*ratio_iCat_slider[iCatPageis][sl])/2,(h_sl*ratio_iCat_slider[iCatPageis][sl])/2));//la size est divisee par 2
 ...
 if(iCat_pos_bouton[iCatPageis][sl][0]<L_tablier_iCat &&  iCat_pos_bouton[iCatPageis][sl][1]<H_tablier_iCat)
{
            ...
            ol::Rect Bouton_Big(
            ol::Vec2D( gx+iCat_pos_bouton[iCatPageis][sl][0],gy+iCat_pos_bouton[iCatPageis][sl][1]),
            ol::Vec2D((largueur_bouton*ratio_iCat_button[iCatPageis][sl])/2,(largueur_bouton*ratio_iCat_button[iCatPageis][sl])/2));//boutons carrés
 ...
 if(iCat_pos_string[iCatPageis][sl][0]<L_tablier_iCat &&  iCat_pos_string[iCatPageis][sl][1]<H_tablier_iCat)
{
            ...
            ol::Rect String_Big(
            ol::Vec2D( gx+iCat_pos_string[iCatPageis][sl][0],gy+iCat_pos_string[iCatPageis][sl][1]),
            ol::Vec2D((largeur_string*ratio_iCat_string[iCatPageis][sl])/2,(hauteur_string*ratio_iCat_string[iCatPageis][sl])/2));//boutons carrés
 ...
 if(iCat_pos_trackzone[iCatPageis][sl][0]<L_tablier_iCat &&  iCat_pos_trackzone[iCatPageis][sl][1]<H_tablier_iCat)
{
            ...
            ol::Rect Trck_Big(
            ol::Vec2D( gx+iCat_pos_trackzone[iCatPageis][sl][0],gy+iCat_pos_trackzone[iCatPageis][sl][1]),
            ol::Vec2D((largeur_trackzone*ratio_iCat_trackzone[iCatPageis][sl])/2,(largeur_trackzone*ratio_iCat_trackzone[iCatPageis][sl])/2));//boutons carrés
...
int BoxGuiBuilder_iCat ( int gx, int gy)
{
   ...
   ol::Rect backFS(ol::Vec2D(gx,gy),ol::Vec2D(largeuriCat,hauteuriCat));
...
ol::Rect iCatPresetO(ol::Vec2D(gx+100,gy+40),ol::Vec2D(70,20));
...
//modulo grid
ol::Rect AffectModulo(ol::Vec2D(gx+180,gy+40),ol::Vec2D(45,20));
...
//copy Page
ol::Rect CopyB(ol::Vec2D(gx+240,gy+40),ol::Vec2D(45,20));
...
ol::Rect iCatPresetR(ol::Vec2D(gx+300,gy+40),ol::Vec2D(70,20));
...
//PRESETS MINUS ET PLUS
   ol::Rect iCatPresetM(ol::Vec2D(gx+380,gy+40),ol::Vec2D(50,20));
  ...
  mouse_released=1;
    ...
    ol::Rect iCatPresetP(ol::Vec2D(gx+440,gy+40),ol::Vec2D(50,20));
...
//APPELS DES 8 PAGES DE PRESET
   ...
   {
    ol::Rect iCatPreset(ol::Vec2D(gx+20+(o*60),gy+70),ol::Vec2D(50,20));
...
int BoxiCat ( int macx, int macy)
{
   ...
   ol::Rect ipFS(ol::Vec2D(macx+20,macy-12),ol::Vec2D(110,25));
   ipFS.SetRoundness(5);
   ...
   ol::Rect pservFS(ol::Vec2D(macx+75,macy+15),ol::Vec2D(50,25));
   ...
   ol::Rect pclFS(ol::Vec2D(macx+75,macy+45),ol::Vec2D(50,25));
   ...
   ol::Rect itFS(ol::Vec2D(macx+75,macy+75),ol::Vec2D(50,25));
   itFS.SetRoundness(5);
   ...
   ol::Rect resFS(ol::Vec2D(macx+75,macy+105),ol::Vec2D(50,20));
