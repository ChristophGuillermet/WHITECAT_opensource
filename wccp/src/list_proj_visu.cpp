...
ol::Line(ol::Vec2D(xlist,ylist),ol::Vec2D(xlist+300,ylist)).Draw(CouleurLigne.WithAlpha(0.5));
char titlemacro[36];
...
{
//comportement
ol::Rect condition_B(ol::Vec2D(xlist, ylist+25+(25*i)),ol::Vec2D(80,20));
...
//valeur 1
ol::Rect lev_B(ol::Vec2D(xlist+90, ylist+25+(25*i)),ol::Vec2D(40,20));
...
//action
ol::Rect action_B(ol::Vec2D(xlist+140, ylist+25+(25*i)),ol::Vec2D(80,20));
...
//valeur 2
ol::Rect Vaction_B(ol::Vec2D(xlist+230, ylist+25+(25*i)),ol::Vec2D(40,20));
...
//on off de la macro
ol::Rect onoff_B(ol::Vec2D(xlist+280, ylist+25+(25*i)),ol::Vec2D(35,20));
...
{
ol::Rect Box_list(ol::Vec2D(xlist, ylist), ol::Vec2D( 350,600));
...
//Edit box
ol::Rect EditList(ol::Vec2D(xlist+290,ylist+16),ol::Vec2D(50,20));
...
//+ minus debug
//Plus Minus buttons
ol::Rect MinusPosList(ol::Vec2D(xlist+290,ylist+51),ol::Vec2D(50,20));
MinusPosList.SetRoundness(7.5);
MinusPosList.SetLineWidth(epaisseur_ligne_fader);
ol::Rect PlusPosList(ol::Vec2D(xlist+290,ylist+81),ol::Vec2D(50,20));
...
{
ol::Rect NameList(ol::Vec2D((xlist+60)-5,(ylist+35+(25*co))),ol::Vec2D(185,23));
...
ol::Rect Curseur_ScrollList(ol::Vec2D(xlist+270,ylist+139+(line_list_is/2)),ol::Vec2D(70,20));
...
//ascenceur
ol::Line(ol::Vec2D(xlist+280,ylist+145),ol::Vec2D(xlist+280,ylist+394)).Draw(CouleurLigne);

ol::Line(ol::Vec2D(xlist+280,ylist+145),ol::Vec2D(xlist+285,ylist+145)).Draw(CouleurLigne);
petitpetitchiffre.Print( "  1 -48" ,xlist+285,ylist+147);
ol::Line(ol::Vec2D(xlist+280,ylist+174),ol::Vec2D(xlist+285,ylist+174)).Draw(CouleurLigne);
petitpetitchiffre.Print( " 49 -96",xlist+285,ylist+176);
ol::Line(ol::Vec2D(xlist+280,ylist+198),ol::Vec2D(xlist+285,ylist+198)).Draw(CouleurLigne);
petitpetitchiffre.Print( " 97-144" ,xlist+285,ylist+200);
ol::Line(ol::Vec2D(xlist+280,ylist+222),ol::Vec2D(xlist+285,ylist+222)).Draw(CouleurLigne);
petitpetitchiffre.Print( "145-192" ,xlist+285,ylist+224);
ol::Line(ol::Vec2D(xlist+280,ylist+246),ol::Vec2D(xlist+285,ylist+246)).Draw(CouleurLigne);
petitpetitchiffre.Print( "193-240" ,xlist+285,ylist+248);
ol::Line(ol::Vec2D(xlist+280,ylist+270),ol::Vec2D(xlist+285,ylist+270)).Draw(CouleurLigne);
petitpetitchiffre.Print( "241-288" ,xlist+285,ylist+272);
ol::Line(ol::Vec2D(xlist+280,ylist+293),ol::Vec2D(xlist+285,ylist+293)).Draw(CouleurLigne);
petitpetitchiffre.Print( "289-336" ,xlist+285,ylist+295);
ol::Line(ol::Vec2D(xlist+280,ylist+316),ol::Vec2D(xlist+285,ylist+316)).Draw(CouleurLigne);
petitpetitchiffre.Print( "337-384" ,xlist+285,ylist+319);
ol::Line(ol::Vec2D(xlist+280,ylist+339),ol::Vec2D(xlist+285,ylist+339)).Draw(CouleurLigne);
petitpetitchiffre.Print( "385-432" ,xlist+285,ylist+341);
ol::Line(ol::Vec2D(xlist+280,ylist+370),ol::Vec2D(xlist+285,ylist+370)).Draw(CouleurLigne);
petitpetitchiffre.Print( "433-480" ,xlist+285,ylist+372);
ol::Line(ol::Vec2D(xlist+280,ylist+394),ol::Vec2D(xlist+285,ylist+394)).Draw(CouleurLigne);
