...
for(int i=0;i<4;i++)
{
ol::Rect Carre(ol::Vec2D(xs+(20*i),ys),ol::Vec2D(10,10));
switch(i)
{
case 0:
...
{
//ligne 1
ol::Rect SavePin(ol::Vec2D(xrep,yrep+(u*15)),ol::Vec2D(10,10));
...
{
//ligne 2
ol::Rect SavePin(ol::Vec2D(xrep+190,yrep+(u*15)),ol::Vec2D(10,10));
...
{
ol::Rect SwitchGlobal(ol::Vec2D(xrep+170,yrep-35),ol::Vec2D(70,20));
...
ol::Rect SavePinSnd(ol::Vec2D(xrep+110,yrep+(u*15)),ol::Vec2D(10,10));
...
ol::Rect SavePinThrd(ol::Vec2D(xrep+240,yrep+(u*15)),ol::Vec2D(10,10));
...
{
ol::Rect backSave(ol::Vec2D(xsave,ysave),ol::Vec2D(420,520));
...
ol::Rect TogBSav(ol::Vec2D(xsave+310,ysave+15),ol::Vec2D(100,20));
...
ol::Rect ShowReport(ol::Vec2D(xsave+300,ysave+430),ol::Vec2D(70,25));
