...
int alarm_window()
{
ol::Rect windowAlarm(ol::Vec2D(XAlarm,YAlarm),ol::Vec2D(300,110));
...
ol::Rect bang_backg(ol::Vec2D(xb,yb), ol::Vec2D(size_X_Banger,size_Y_Banger));
...
ol::Rect BangNumBox(ol::Vec2D(xb+190,yb+10),ol::Vec2D(50,25));
...
ol::Rect GiveNameOfBanger(ol::Vec2D(xb+200,yb+40), ol::Vec2D( 170,30));
...
ol::Circle BangerPlus(ol::Vec2D(xb+160,yb+55),12);
ol::Circle BangerMinus(ol::Vec2D(xb+120,yb+55),12);
...
ol::Rect CopyTo( ol::Vec2D((xb+280),(yb+10)),ol::Vec2D(90,20));
...
ol::Rect BangerEditEnable( ol::Vec2D((xb+410),(yb+10)),ol::Vec2D(50,20));
...
///BANG DO IT
ol::Rect BangerIt( ol::Vec2D((xb+410),(yb+40)),ol::Vec2D(60,30));
...
//mapping clavier
ol::Rect Kbdb( ol::Vec2D((xb),(yb)),ol::Vec2D(40,20));
ol::Rect KbdShift(ol::Vec2D((xb),(yb)),ol::Vec2D(40,20));

ol::Rect BangEvent(ol::Vec2D(xb,yb),ol::Vec2D(100,20));

ol::Rect BangAction(ol::Vec2D(xb,yb),ol::Vec2D(115,20));

ol::Rect BoxVal1(ol::Vec2D(xb,yb),ol::Vec2D(40,20));

ol::Rect BoxVal2(ol::Vec2D(xb,yb),ol::Vec2D(40,20));

ol::Rect BoxDelay(ol::Vec2D(xb,yb),ol::Vec2D(40,20));

for (int lp=0;lp<6;lp++)//6 ev en bang
{
BangEvent.MoveTo(ol::Vec2D(xb+30,yb+100+(lp*30)));
BangEvent.SetRoundness(5);
BangEvent.Draw(CouleurBleuProcedure);

BangAction.MoveTo(ol::Vec2D(xb+145,yb+100+(lp*30)));
BangAction.SetRoundness(5);
BangAction.Draw(CouleurBleuProcedure);

BoxVal1.MoveTo(ol::Vec2D(xb+270,yb+100+(lp*30)));
BoxVal1.SetRoundness(5);
BoxVal1.Draw(CouleurBleuProcedure);

BoxVal2.MoveTo(ol::Vec2D(xb+320,yb+100+(lp*30)));
BoxVal2.SetRoundness(5);
BoxVal2.Draw(CouleurBleuProcedure);

BoxDelay.MoveTo(ol::Vec2D(xb+380,yb+100+(lp*30)));
BoxDelay.SetRoundness(5);
BoxDelay.Draw(CouleurBleuProcedure);

ol::Circle Bangsolo(ol::Vec2D(xb+450,yb+110+(lp*30)),10);
...
Kbdb.MoveTo(ol::Vec2D(xb+470,yb+100+(lp*30)));
Kbdb.DrawOutline(CouleurFader.WithAlpha(0.5));
KbdShift.MoveTo(ol::Vec2D(xb+515,yb+100+(lp*30)));
...
{
ol::Rect BoxAlarm(ol::Vec2D(xb+145,yb+100+(lp*30)),ol::Vec2D(170,20));
