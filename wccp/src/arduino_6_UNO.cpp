...
ol::Rect Comport(ol::Vec2D(cfg_X+120,cfg_Y+30),ol::Vec2D(50,25));
...
ol::Rect BaudrateB(ol::Vec2D(cfg_X+120,cfg_Y+60),ol::Vec2D(50,25));
...
ol::Rect ReqrateB(ol::Vec2D(cfg_X+120,cfg_Y+90),ol::Vec2D(50,25));
...
ol::Rect MaxIOB(ol::Vec2D(cfg_X+120,cfg_Y+120),ol::Vec2D(50,25));
...
ol::Rect MaxAnB(ol::Vec2D(cfg_X+120,cfg_Y+150),ol::Vec2D(50,25));
...
ol::Rect MaxDIB(ol::Vec2D(cfg_X+120,cfg_Y+180),ol::Vec2D(50,25));
...
ol::Rect OpenB(ol::Vec2D(cfg_X+120,cfg_Y+210),ol::Vec2D(50,25));
...
ol::Rect arduino_send(ol::Vec2D(cfg_X+120,cfg_Y+240),ol::Vec2D(50,25));
...
ol::Rect OverTyp(ol::Vec2D(cfg_X+200+5,(cfg_Y+40+(y*20)-10)),ol::Vec2D(70,18));
OverTyp.SetRoundness(7.5);
OverTyp.Draw(CouleurFond.WithAlpha(0.3));

ol::Rect OverAction(ol::Vec2D(cfg_X+280+5,(cfg_Y+40+(y*20)-10)),ol::Vec2D(140,18));
OverAction.SetRoundness(7.5);
OverAction.Draw(CouleurFond.WithAlpha(0.3));

ol::Rect OverVal(ol::Vec2D(cfg_X+430+5,(cfg_Y+40+(y*20)-10)),ol::Vec2D(30,18));
OverVal.SetRoundness(7.5);
OverVal.Draw(CouleurFond.WithAlpha(0.3));

/////////ANA///////////////////////////////////////////////////////////////

ol::Rect OverAff(ol::Vec2D(cfg_X+520+5,(cfg_Y+40+(y*20)-10)),ol::Vec2D(105,18));
OverAff.SetRoundness(7.5);
if(position_line_ana+y<=arduino_max_analog)
{OverAff.Draw(CouleurFond.WithAlpha(0.3));}

ol::Rect OverValA(ol::Vec2D(cfg_X+630+5,(cfg_Y+40+(y*20)-10)),ol::Vec2D(30,18));
...
/////////////////UP DOWN LINE IO /////////////////////
ol::Circle LineUp(ol::Vec2D(cfg_X+400,cfg_Y+15),12);
LineUp.Draw(CouleurFond.WithAlpha(0.3));
ol::Circle LineDown(ol::Vec2D(cfg_X+440,cfg_Y+15),12);
...
/////////////////UP DOWN ANA /////////////////////
ol::Circle LineUpA(ol::Vec2D(cfg_X+660,cfg_Y+15),12);
LineUpA.Draw(CouleurFond.WithAlpha(0.3));
ol::Circle LineDownA(ol::Vec2D(cfg_X+700,cfg_Y+15),12);
