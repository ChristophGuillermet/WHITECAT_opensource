...
ol::Rect BackHelp(ol::Vec2D(xhelp,yhelp),ol::Vec2D(700,300));
...
//////////////////UP DOWN LINE IMPORT/////////////////////
ol::Circle LineUp(ol::Vec2D(xhelp+660,yhelp+40),12);
LineUp.Draw(CouleurFond);
ol::Circle LineDown(ol::Vec2D(xhelp+660,yhelp+260),12);
...
ol::Rect TitleUnder(ol::Vec2D(xhelp+5,yhelp+45),ol::Vec2D(620,25));
...
{
ol::Rect TitleBar(ol::Vec2D(xhelp+5,yhelp+75+(tx*15)),ol::Vec2D(620,15));
...
ol::Rect Bdoctype(ol::Vec2D(xhelp+570,yhelp+47),ol::Vec2D(50,20));
