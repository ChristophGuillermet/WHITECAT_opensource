...
{
ol::Circle myartnet_diode_vide( x_diods+10+(dd*20), y_diods+10, 5.0, 5.0 );
...
{
ol::Circle myartnet_temoin(x_diods+10+(incoming_artnet*20), y_diods+10, 5.0, 5.0 );
...
{
ol::Circle myartnet_temoin(x_diods+10+(outgoing_artnet*20), y_diods+10, 5.0, 5.0 );
...
ol::Rect ArtPollReplyPanel(ol::Vec2D(apr_X,  apr_Y), ol::Vec2D( 500,250));
