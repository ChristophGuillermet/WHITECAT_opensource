...
{
ol::Rect SetLoopIN(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
SetLoopIN.SetRoundness(4);

if(state==1){SetLoopIN.Draw(CouleurBlind);}

SetLoopIN.DrawOutline(CouleurLigne);
ol::Line(ol::Vec2D(xp,yp),ol::Vec2D(xp+10,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+20,yp),ol::Vec2D(xp+10,yp+10)).Draw(CouleurLigne);
...
{
ol::Rect SetLoopOUT(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
...
{
//Seek cue
ol::Rect SeekCue(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
...
ol::Rect FwdSens(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
FwdSens.SetRoundness(4);

if(state==1){FwdSens.Draw(CouleurFader);}
FwdSens.DrawOutline(CouleurLigne);

ol::Line(ol::Vec2D(xp+4,yp+10),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+12,yp+7),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+12,yp+13),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
...
ol::Rect BckSens(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
...
ol::Line(ol::Vec2D(xp+4,yp+10),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+10,yp+7),ol::Vec2D(xp+4,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+10,yp+13),ol::Vec2D(xp+4,yp+10)).Draw(CouleurLigne);
...
ol::Rect BckFwdSens(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
BckFwdSens.SetRoundness(4);

if(state==1){BckFwdSens.Draw(CouleurFader);}
BckFwdSens.DrawOutline(CouleurLigne);

ol::Line(ol::Vec2D(xp+2,yp+10),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+15,yp+7),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+15,yp+13),ol::Vec2D(xp+18,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+7),ol::Vec2D(xp+2,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+13),ol::Vec2D(xp+2,yp+10)).Draw(CouleurLigne);
...
{
ol::Rect Btrack_up(ol::Vec2D(xp,yp),ol::Vec2D(40,20));
Btrack_up.SetRoundness(4);
if(state==1){ Btrack_up.Draw(CouleurFader);}
Btrack_up.DrawOutline(CouleurLigne);
ol::Line(ol::Vec2D(xp,yp+20),ol::Vec2D(xp+40,yp+5)).Draw(CouleurLigne);
...
{
ol::Rect Btrack_stay(ol::Vec2D(xp,yp),ol::Vec2D(40,20));
Btrack_stay.SetRoundness(4);
if(state==1){ Btrack_stay.Draw(CouleurGreen);}
Btrack_stay.DrawOutline(CouleurLigne);
ol::Line(ol::Vec2D(xp,yp+5),ol::Vec2D(xp+40,yp+5)).Draw(CouleurLigne);
...
Btrack_stay.DrawOutline(CouleurLigne);
ol::Line(ol::Vec2D(xp,yp+5),ol::Vec2D(xp+40,yp+20)).Draw(CouleurLigne);
...
ol::Circle tChazeMinus(ol::Vec2D(xcha+20,ycha+25),12);
ol::Circle tChazePlus(ol::Vec2D(xcha+20,ycha+55),12);
//up triangle
ol::Line(ol::Vec2D(xcha+12,ycha+30),ol::Vec2D(xcha+28,ycha+30)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+12,ycha+30),ol::Vec2D(xcha+20,ycha+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+28,ycha+30),ol::Vec2D(xcha+20,ycha+16)).Draw(CouleurLigne);

//down triangle
ol::Line(ol::Vec2D(xcha+12,ycha+49),ol::Vec2D(xcha+28,ycha+49)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+12,ycha+49),ol::Vec2D(xcha+20,ycha+63)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+28,ycha+49),ol::Vec2D(xcha+20,ycha+63)).Draw(CouleurLigne);
...
ol::Circle LchChazeMinus(ol::Vec2D(xcha+20,ycha+25),12);
ol::Circle LchChazePlus(ol::Vec2D(xcha+50,ycha+25),12);
//left triangle
ol::Line(ol::Vec2D(xcha+12,ycha+25),ol::Vec2D(xcha+24,ycha+30)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+12,ycha+25),ol::Vec2D(xcha+24,ycha+20)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+24,ycha+20),ol::Vec2D(xcha+24,ycha+30)).Draw(CouleurLigne);
//right triangle
ol::Line(ol::Vec2D(xcha+45,ycha+30),ol::Vec2D(xcha+56,ycha+25)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+56,ycha+25),ol::Vec2D(xcha+45,ycha+20)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xcha+45,ycha+20),ol::Vec2D(xcha+45,ycha+30)).Draw(CouleurLigne);
...
//track selected
ol::Rect Btrack_sel(ol::Vec2D(xp,yp),ol::Vec2D(20,20));
...
//master
ol::Rect track_fader(ol::Vec2D(xp+30,yp),ol::Vec2D(127,10));
ol::Rect track_levelview(ol::Vec2D(xp+30,yp),ol::Vec2D(track_level[chaser_selected][num_track],10));
...
ol::Circle BMidiOut( xp+180,yp+22, 5);//box du fader
...
{
ol::Rect TCase(ol::Vec2D(xp+170+(chcase*12),yp),ol::Vec2D(12,12));
