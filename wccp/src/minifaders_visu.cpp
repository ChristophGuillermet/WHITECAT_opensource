...
{
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(xs+12,ys+20)).Draw(CouleurLigne);//barre milieu vert
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(xs+5,ys+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(xs+19,ys+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+5,ys+5),ol::Vec2D(xs+20,ys+5)).Draw(CouleurLigne);//barre d arret
return(0);
}
int draw_sign_down(int xs,int ys)
{
ol::Line(ol::Vec2D(xs+12,ys+2),ol::Vec2D(xs+12,ys+15)).Draw(CouleurLigne);//barre milieu vert
ol::Line(ol::Vec2D(xs+12,ys+15),ol::Vec2D(xs+5,ys+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+15),ol::Vec2D(xs+19,ys+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+5,ys+15),ol::Vec2D(xs+20,ys+15)).Draw(CouleurLigne);//barre d arret
return(0);
}
int draw_sign_saw(int xs,int ys)
{
ol::Line(ol::Vec2D(xs+5,ys+5),ol::Vec2D(ol::Vec2D(xs+10,ys+15))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+10,ys+15),ol::Vec2D(ol::Vec2D(xs+15,ys+5))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+15,ys+5),ol::Vec2D(ol::Vec2D(xs+20,ys+15))).Draw(CouleurLigne);
return(0);
}
int draw_sign_prev(int xs,int ys)
{
ol::Line(ol::Vec2D(xs,ys+15),ol::Vec2D(ol::Vec2D(xs+12,ys+15))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+10),ol::Vec2D(ol::Vec2D(xs+12,ys+15))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(ol::Vec2D(xs+9,ys+10))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(ol::Vec2D(xs+15,ys+10))).Draw(CouleurLigne);
return(0);
}

int draw_sign_next(int xs,int ys)
{
ol::Line(ol::Vec2D(xs,ys+5),ol::Vec2D(ol::Vec2D(xs+12,ys+5))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(ol::Vec2D(xs+12,ys+15))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+15),ol::Vec2D(ol::Vec2D(xs+9,ys+10))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+15),ol::Vec2D(ol::Vec2D(xs+15,ys+10))).Draw(CouleurLigne);
 return(0);
}

int draw_sign_up_down(int xs, int ys)
{
ol::Line(ol::Vec2D(xs+12,ys+10),ol::Vec2D(ol::Vec2D(xs+12,ys+20))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+20),ol::Vec2D(ol::Vec2D(xs+9,ys+15))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+20),ol::Vec2D(ol::Vec2D(xs+15,ys+15))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+10),ol::Vec2D(ol::Vec2D(xs+12,ys+5))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(ol::Vec2D(xs+9,ys+10))).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xs+12,ys+5),ol::Vec2D(ol::Vec2D(xs+15,ys+10))).Draw(CouleurLigne);
 return(0);
}
...
ol::Rect FgOn(ol::Vec2D(xs,ys),ol::Vec2D(10,10));
...
if(DockTypeIs[fad][dk]==13)
 {
 FgOn.MoveTo(ol::Vec2D(xs+3+(15*i),ys+13+(20*u)));
...
ol::Rect Commande(ol::Vec2D(xf,yf),ol::Vec2D(50,20));
Commande.SetRoundness(4);
Commande.DrawOutline(CouleurLigne.WithAlpha(0.5));
for (int u=0;u<8;u++)
{
Commande.MoveTo(ol::Vec2D(xf,yf+10+(25*u)));
 switch(u)
 {
           case 0:
...
{
ol::Rect FondMiniFaders(ol::Vec2D(xmf-10,ymf-50),ol::Vec2D(700,450));
...
////LE SYSTEME D ORDRES////////////////////////////////////////////////////////
ol::Rect SelAllFader(ol::Vec2D(xmf+(24*larg)+10,ymf-25),ol::Vec2D(45,20));
...
////////////////////////////////////////////////////////////////////////////
ol::Rect FaderLittlePrevSel(ol::Vec2D(xmf+(24*larg)+10,ymf),ol::Vec2D(20,20));
...
ol::Rect FaderLittleNextSel(ol::Vec2D(xmf+(24*larg)+35,ymf),ol::Vec2D(20,20));
...
ol::Rect SelFader(ol::Vec2D(xmf+(24*larg)+10,ymf+25),ol::Vec2D(45,20));
...
ol::Rect UnSelFader(ol::Vec2D(xmf+(24*larg)+10,ymf+50),ol::Vec2D(45,20));
...
/////////////////LES ACTIONS////////////////////////////////////////////////////
ol::Rect FaderLittleCmd(ol::Vec2D(xmf,ymf),ol::Vec2D(20,20));
...
{
int numcom=(lu*3)+llu;
FaderLittleCmd.MoveTo(ol::Vec2D(xmf+(24*larg)+70+(lu*25),ymf+(llu*25)));
...
{//loop one
ol::Circle OLLoop(ol::Vec2D((xmf+(24*larg)+70+(lu*25)+10),(ymf+(llu*25)+10)),5);
...
{//loop all
ol::Circle OLLoopA(ol::Vec2D((xmf+(24*larg)+80+(lu*25)),(ymf+(llu*25)+5)),2);
OLLoopA.Draw(CouleurFader);
OLLoopA.DrawOutline(CouleurLigne);
OLLoopA.MoveBy(ol::Vec2D(0,5));
OLLoopA.Draw(CouleurFader);
OLLoopA.DrawOutline(CouleurLigne);
OLLoopA.MoveBy(ol::Vec2D(0,5));
OLLoopA.Draw(CouleurFader);
...
{
//play chaser embeded
ol::Line(ol::Vec2D(xmf+(24*larg)+76+(lu*25),ymf+(llu*25)+4),ol::Vec2D(xmf+(24*larg)+76+(lu*25),ymf+(llu*25)+16)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xmf+(24*larg)+76+(lu*25),ymf+(llu*25)+4),ol::Vec2D(xmf+(24*larg)+86+(lu*25),ymf+(llu*25)+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xmf+(24*larg)+76+(lu*25),ymf+(llu*25)+16),ol::Vec2D(xmf+(24*larg)+86+(lu*25),ymf+(llu*25)+10)).Draw(CouleurLigne);
}
...
ol::Rect FaderPstCmd(ol::Vec2D(xmf,ymf),ol::Vec2D(20,20));
FaderPstCmd.SetRoundness(3);
for(int lg=0;lg<8;lg++)
{
FaderPstCmd.MoveTo(ol::Vec2D(xmf+(24*larg)+10,ymf+90+(lg*25)));
...
ol::Rect Lock(ol::Vec2D(xmf,ymf),ol::Vec2D(20,20));
Lock.SetRoundness(3);

for(int lck=0;lck<8;lck++)
{
Lock.MoveTo(ol::Vec2D(xmf+(24*larg)+35,ymf+90+(lck*25)));
...
ol::Rect FaderDescr(ol::Vec2D(xmf+(24*larg)+5,ymf+290),ol::Vec2D(160,100));
...
ol::Rect FaderSelB(ol::Vec2D(xmf,ymf),ol::Vec2D(larg-2,15));
FaderSelB.SetRoundness(3);
ol::Rect FxMode(ol::Vec2D(xmf,ymf),ol::Vec2D(larg-2,5));
ol::Rect FaderLittle(ol::Vec2D(xmf,ymf),ol::Vec2D(larg-5,127));
FaderLittle.SetRoundness(3);
ol::Rect FlashTouch(ol::Vec2D(xmf,ymf),ol::Vec2D(larg-5,10));
...
{
FaderSelB.MoveTo(ol::Vec2D(xmf+(cmptfader*larg)-1,ymf+(lfad*hmfd)-2));

FaderSelB.Draw(CouleurLigne.WithAlpha(0.3));

//mode compositing
FxMode.MoveTo(ol::Vec2D(xmf+(cmptfader*larg)-1,ymf+(lfad*hmfd)-12));
...
FaderLittle.MoveTo(ol::Vec2D(xmf+(cmptfader*larg),ymf+20+(lfad*hmfd)));
int niveau=(int)Fader[cmptfader+(lfad*24)];
ol::Rect FaderLittleNiveau( ol::Vec2D(  xmf+(cmptfader*larg),(ymf+127)+20+(lfad*hmfd) - (niveau/2)), ol::Vec2D( larg-5,(niveau/2)));//niveau fader
...
{
//affichage niveau
ol::Line MonNiveauMidi(ol::Vec2D(xmf+(cmptfader*larg),ymf+20+(lfad*hmfd)+127 -val_raccrochage_midi[cmptfader +(lfad*24)]),ol::Vec2D(xmf+(cmptfader*larg)+larg-5,ymf+20+(lfad*hmfd)+127 -val_raccrochage_midi[cmptfader +(lfad*24)]));
...
{
case 0:
ol::Line(ol::Vec2D(xmf+(cmptfader*larg),(ymf+20+127+(lfad*hmfd) - (LevelStopPos[cmptfader+(lfad*24)]/2))),ol::Vec2D(xmf+(cmptfader*larg)+larg-5,(ymf+20+127+(lfad*hmfd) - (LevelStopPos[cmptfader+(lfad*24)]/2)))).Draw(CouleurLigne);
petitpetitchiffre.Print(string_fader_stop_pos[cmptfader],xmf+(cmptfader*larg)+2,(ymf+127+20 - (LevelStopPos[cmptfader+(lfad*24)]/2)));
break;
case 1:
ol::Line(ol::Vec2D(xmf+(cmptfader*larg),(ymf+20+127 - (LevelStopPos[cmptfader+(lfad*24)]/2))),ol::Vec2D(xmf+(cmptfader*larg)+larg-5,(ymf+127+20 - (LevelStopPos[cmptfader+(lfad*24)]/2)))).Draw(CouleurBlind);
...
//Flash du Fader//////////////////////////////////////////////////////////////////
FlashTouch.MoveTo(ol::Vec2D(xmf+(cmptfader*larg),ymf+175+(lfad*hmfd)));
FlashTouch.SetRoundness(3);
...
ol::Circle DLLoop(ol::Vec2D((xmf+(cmptfader*larg)+12),(ymf+177+(lfad*hmfd))),2);
