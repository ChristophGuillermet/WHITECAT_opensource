...
{ol::Settings::SetWindowBorder(false);}
else
{ol::Settings::SetWindowBorder(true);}

ol::Setup::SetupProgram(ol::KEYBOARD | ol::MOUSE);

if(index_fullscreen==0)
{ol::Setup::SetupScreen( largeur_ecran, hauteur_ecran,WINDOWED, desktop_color_depth() );}
else {ol::Setup::SetupScreen( largeur_ecran, hauteur_ecran,FULLSCREEN, desktop_color_depth() );}
