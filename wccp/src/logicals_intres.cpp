...
int fenetre_confirm()
{
 ...
 ol::Rect FenetreConfirm(ol::Vec2D(XConfirm,YConfirm),ol::Vec2D(400,100));
 ...
 neuromoyen.Print( string_confirmation,XConfirm+110,YConfirm+10+18, 250, ol::JUSTIFY);


 ol::Rect EscBox(ol::Vec2D(XConfirm+110,YConfirm+60),ol::Vec2D(70,30));
 ...
 petitchiffre.Print("ESC",XConfirm+110+18, YConfirm+60+18);
  ...
  ol::Rect OkBox(ol::Vec2D(XConfirm+240,YConfirm+60),ol::Vec2D(70,30));
