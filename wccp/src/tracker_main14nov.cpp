...
//COULEURS
ol::Rgba CouleurFond(0.0,0.0,0.0);
ol::Rgba Gris( 0.0, 0.0, 0.0 );
ol::Rgba CouleurLigne(1.0,1.0,1.0);
ol::Rgba CouleurFader(1.0,0.4,0.0);
ol::Rgba CouleurSurvol(0.8,0.0,0.0);
ol::Rgba CouleurLevel(0.5,0.7,0.6);
ol::Rgba CouleurSelection(0.5,0.0,0.7);
ol::Rgba CouleurNiveau(0.1,0.0,0.6);
ol::Rgba CouleurBlind(1.0,0.0,0.0);
ol::Rgba CouleurLock(0.0,0.4,0.2);
ol::Rgba CouleurConfig(0.1,0.1,0.3);
ol::Rgba CouleurBleuProcedure(0.0,0.2,0.5);
...
int old_zoom_fine=0;
 ...
 while(index_quit!=1)
 {
     ...
     ol::Line( ol::Vec2D( mouse_x-1,mouse_y-1), ol::Vec2D( mouse_x+20,mouse_y+30),3.0).Draw( CouleurFader );
     ol::Line( ol::Vec2D( mouse_x+20,mouse_y+30), ol::Vec2D( mouse_x+30,mouse_y+10),3.0).Draw( CouleurFader );
     ol::Line( ol::Vec2D( mouse_x+30,mouse_y+10), ol::Vec2D( mouse_x-1,mouse_y-1),3.0).Draw( CouleurFader );
