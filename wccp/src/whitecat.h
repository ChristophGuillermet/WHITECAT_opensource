...
///////////////////////COULEURS ET POLICES//////////////////////////////////////
ol::Rgba CouleurFond;
ol::Rgba CouleurLigne;
ol::Rgba CouleurFader;
ol::Rgba CouleurPatch;
ol::Rgba CouleurSurvol;
ol::Rgba CouleurLevel;
ol::Rgba CouleurSelection;
ol::Rgba CouleurNiveau;
ol::Rgba CouleurBlind;
ol::Rgba CouleurLock;
ol::Rgba CouleurConfig;
ol::Rgba CouleurBleuProcedure;
ol::Rgba CouleurYellow(0.6,0.6,0.0);
ol::Rgba CouleurYellowFgroup(1.0,0.7,0.0);
ol::Rgba CouleurGreen(0.0,0.6,0.0);
ol::Rgba CouleurRed(0.6,0.0,0.0);
ol::Rgba CouleurRougePur(1.0,0.0,0.0);
ol::Rgba CouleurFondDefaut(0.0,0.0,0.0);
ol::Rgba CouleurLigneDefaut(1.0,1.0,1.0);
ol::Rgba CouleurFaderDefaut(1.0,0.4,0.0);
ol::Rgba CouleurPatchDefaut(1.0,0.2,0.0);
ol::Rgba CouleurSurvolDefaut(0.8,0.0,0.0);
ol::Rgba CouleurLevelDefaut(0.5,0.7,0.6);
ol::Rgba CouleurSelectionDefaut(0.5,0.0,0.7);
ol::Rgba CouleurNiveauDefaut(0.1,0.0,0.7);
ol::Rgba CouleurBlindDefaut(1.0,0.0,0.0);
ol::Rgba CouleurLockDefaut(0.0,0.4,0.2);
ol::Rgba CouleurConfigDefaut(0.1,0.1,0.3);
ol::Rgba CouleurBleuProcedureDefaut(0.0,0.2,0.5);

ol::Rgba CouleurBlanc(1.0,1.0,1.0);
ol::Rgba CouleurGrisTresClair(0.8,0.8,0.8);
ol::Rgba CouleurGrisClair(0.6,0.6,0.6);
ol::Rgba CouleurGrisMoyen(0.4,0.4,0.4);
ol::Rgba CouleurGrisAnthracite(0.2,0.2,0.2);
ol::Rgba CouleurNoir(0.0,0.0,0.0);

ol::Rgba CouleurBleu10(0.1,0.1,1.0);
ol::Rgba CouleurBleu8(0.1,0.1,0.8);
ol::Rgba CouleurBleu6(0.1,0.1,0.6);
ol::Rgba CouleurBleu4(0.1,0.1,0.4);
ol::Rgba CouleurBleu2(0.1,0.1,0.2);
ol::Rgba CouleurBleu1(0.0,0.0,0.1);

ol::Rgba Discrete1(0.023529,0.023529,0.082353);
ol::Rgba Discrete2(0.2,0.2,0.4);
ol::Rgba Discrete3(0.6,0.6,0.7);
ol::Rgba Discrete4(0.6,0.8,0.7);
ol::Rgba Discrete5(0.7,0.3,0.4);
ol::Rgba Discrete6(0.9,0.0,0.0);
ol::Rgba Discrete7(0.1,0.8,0.0);
ol::Rgba Discrete8(0.2,0.4,0.8);
ol::Rgba Discrete9(0.2,0.2,0.3);
ol::Rgba Discrete10(0.8,0.7,0.7);
ol::Rgba Discrete11(0.9,0.0,0.8);
ol::Rgba Discrete12(0.2,0.3,0.2);

ol::Rgba Matrix1(0.0,0.1,0.0);
ol::Rgba Matrix2(0.0,1.0,0.0);
ol::Rgba Matrix3(0.0,0.8,0.0);
ol::Rgba Matrix4(0.0,0.2,0.0);
ol::Rgba Matrix5(0.0,0.9,0.0);
ol::Rgba Matrix6(0.0,1.0,0.0);
ol::Rgba Matrix7(0.0,0.9,0.0);
ol::Rgba Matrix8(0.0,1.0,0.0);
ol::Rgba Matrix9(0.0,0.2,0.0);
ol::Rgba Matrix10(0.0,0.3,0.0);
ol::Rgba Matrix11(0.6,0.9,0.0);
ol::Rgba Matrix12(0.2,0.7,0.2);

ol::Rgba CouleurUserLoop;
ol::Rgba CouleurUser1;
ol::Rgba CouleurUser2;
ol::Rgba CouleurUser3;
ol::Rgba CouleurUser4;
ol::Rgba CouleurUser5;
ol::Rgba CouleurUser6;
ol::Rgba CouleurUser7;
ol::Rgba CouleurUser8;
ol::Rgba CouleurUser9;
ol::Rgba CouleurUser10;
ol::Rgba CouleurUser11;
ol::Rgba CouleurUser12;


ol::Rgba CouleurPreviewHue;
ol::Rgba CouleurPreviewChroma;

ol::TextRenderer axaxax12;
ol::TextRenderer doom;
ol::TextRenderer doomblanc;
ol::TextRenderer petitdoomblanc;
ol::TextRenderer minidoomblanc;
ol::TextRenderer doomrouge;
ol::TextRenderer neuro;
ol::TextRenderer neuromoyen;
ol::TextRenderer petitchiffre;
ol::TextRenderer circuitlevel;
ol::TextRenderer circuitfaderlevel;
ol::TextRenderer circuitblindlevel;
ol::TextRenderer petitpetitchiffre;
ol::TextRenderer petitpetitchiffregris;
ol::TextRenderer petitpetitchiffrerouge;
ol::TextRenderer petitchiffrerouge;
ol::TextRenderer petitchiffrenoir;
ol::TextRenderer petitdoomInspekt;
ol::TextRenderer petitdoomrouge;
ol::TextRenderer neuroTitle;
ol::TextRenderer minichiffre;
ol::TextRenderer minichiffregris;
ol::TextRenderer minichiffrerouge;
ol::TextRenderer minichiffrenoir;
//IMPORT SCHWZ////////////////////////////////////////////////////////////////////////
...
ol::Rgba CouleurPlotLine(0.0,0.0,0.0);
ol::Rgba CouleurPlotFill(0.6,0.6,0.6);
...
ol::TextRenderer PlotTextRenderer;
