...
ol::Rect nameAera( ol::Vec2D( ((largeur_ecran/2)-200),((hauteur_ecran/2)-100)), ol::Vec2D( 400,70));
...
ol::Circle BMidiOut( xmi,ymi, 10); //box du fader
...
CouleurBlind=ol::Rgba::RED;
CouleurLock=CouleurBlanc;
petitchiffre.SetColor(ol::Rgba::BLACK);
petitpetitchiffre.SetColor(ol::Rgba::BLACK);
petitchiffrenoir.SetColor(ol::Rgba::WHITE);
circuitlevel.SetColor(ol::Rgba::WHITE);
...
sprintf(shape_nickname[9],"ol::Circle Slice");
