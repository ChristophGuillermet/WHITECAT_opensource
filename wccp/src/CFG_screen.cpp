...
{
//////////////////SCREEN SIZE//////////////////////////////////////////////////
ol::Rect EncadreScreen(ol::Vec2D(x_cfg_sc+10,y_cfg_sc+40),ol::Vec2D(200,230));
...
{
ol::Rect screen_mode(ol::Vec2D( x_cfg_sc+20,y_cfg_sc+75+(lps*30)),ol::Vec2D(55,15));
...
ol::Rect boxlargeur(ol::Vec2D((x_cfg_sc+100),y_cfg_sc+190),ol::Vec2D(65,30));
boxlargeur.SetRoundness(7.5);
boxlargeur.Draw(CouleurFond.WithAlpha(0.5));


ol::Rect boxhauteur(ol::Vec2D((x_cfg_sc+100),y_cfg_sc+225),ol::Vec2D(65,30));
...
ol::Rect EncadrePos(ol::Vec2D(x_cfg_sc+10+230,y_cfg_sc+40),ol::Vec2D(200,230));
...
{
ol::Rect pos_mode(ol::Vec2D( x_cfg_sc+250,y_cfg_sc+75+(lpos*30)),ol::Vec2D(55,15));
...
ol::Rect boxposx(ol::Vec2D((x_cfg_sc+330),y_cfg_sc+190),ol::Vec2D(65,30));
boxposx.SetRoundness(7.5);
boxposx.Draw(CouleurFond.WithAlpha(0.5));

ol::Rect boxposy(ol::Vec2D((x_cfg_sc+330),y_cfg_sc+225),ol::Vec2D(65,30));
...
ol::Rect EncadreTheme(ol::Vec2D(x_cfg_sc+470,y_cfg_sc+40),ol::Vec2D(350,230));
...
{
ol::Rect theme_mode(ol::Vec2D( x_cfg_sc+480,y_cfg_sc+75+(thp*30)),ol::Vec2D(55,15));
...
ol::Rect theme_receive(ol::Vec2D( x_cfg_sc+665,y_cfg_sc+105),ol::Vec2D(55,15));
...
for (int lg=0;lg<3;lg++)
{
 ...
 {
 ol::Rect ColUser(ol::Vec2D(x_cfg_sc+660+(cl*40),y_cfg_sc+140+(lg*40)),ol::Vec2D(30,30));
...
//ventilation couleurs
 if(receive_from_trichro==1 && index_affect_color_to_dock==1)
 {
  ...
  ol::Rgba TmpColor (couleurs_user[index_color_user_selected][0],couleurs_user[index_color_user_selected][1],couleurs_user[index_color_user_selected][2]);
...
//////////////////SCREEN SIZE//////////////////////////////////////////////////
ol::Rect EncadreUseCol(ol::Vec2D(x_cfg_sc+655,y_cfg_sc+90),ol::Vec2D(160,170));
...
ol::Line(ol::Vec2D(x_cfg_sc+655,y_cfg_sc+230),ol::Vec2D(x_cfg_sc+630,y_cfg_sc+230)).Draw(CouleurLigne);
