...
{
ol::Rect FaderSon(ol::Vec2D(xp,yp),ol::Vec2D(20,127));
FaderSon.SetRoundness(5);
ol::Rect FaderSonNiveau(ol::Vec2D(xp,yp+(127-player_niveauson[numero])),ol::Vec2D(20,player_niveauson[numero]));
...
ol::Line (ol::Vec2D(xp+20,yp+107),ol::Vec2D(xp+30,yp+112)).Draw(CouleurLigne);

ol::Circle(ol::Vec2D(xp+37,yp+117),7).Draw(CouleurBlind.WithAlpha(midi_send_out[616+numero]));
ol::Circle(ol::Vec2D(xp+37,yp+117),7).DrawOutline(CouleurLigne);
...
//PLAY / Pause
ol::Rect Play(ol::Vec2D(xp,yp+30),ol::Vec2D(20,20));
Play.SetRoundness(4);
...
ol::Line(ol::Vec2D(xp+6,yp+34),ol::Vec2D(xp+6,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+34),ol::Vec2D(xp+16,yp+40)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+6,yp+46),ol::Vec2D(xp+16,yp+40)).Draw(CouleurLigne);
...
//SEEK TO 0
ol::Rect SeekToZero(ol::Vec2D(xp+25,yp+30),ol::Vec2D(20,20));
SeekToZero.SetRoundness(4);
SeekToZero.Draw(CouleurFond.WithAlpha(0.5));
ol::Line(ol::Vec2D(xp+41,yp+34),ol::Vec2D(xp+41,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+41,yp+34),ol::Vec2D(xp+31,yp+40)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+31,yp+40),ol::Vec2D(xp+41,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+29,yp+34),ol::Vec2D(xp+29,yp+46)).Draw(CouleurLigne);
...
//GENERAL LOOP
ol::Rect GeneralLoop(ol::Vec2D(xp+50,yp+30),ol::Vec2D(20,20));
GeneralLoop.SetRoundness(4);
GeneralLoop.Draw(CouleurFond.WithAlpha(0.5));
GeneralLoop.DrawOutline(CouleurLigne.WithAlpha(0.5));
ol::Circle(ol::Vec2D(xp+60,yp+40),5).Draw(CouleurFader.WithAlpha(player_is_onloop[numero]));
ol::Circle(ol::Vec2D(xp+60,yp+40),5).DrawOutline(CouleurLigne);




//SEEK TO End
ol::Rect SeekToEnd(ol::Vec2D(xp+75,yp+30),ol::Vec2D(20,20));
SeekToEnd.SetRoundness(4);
SeekToEnd.Draw(CouleurFond.WithAlpha(0.5));
ol::Line(ol::Vec2D(xp+79,yp+34),ol::Vec2D(xp+79,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+79,yp+34),ol::Vec2D(xp+89,yp+40)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+89,yp+40),ol::Vec2D(xp+79,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+91,yp+34),ol::Vec2D(xp+91,yp+46)).Draw(CouleurLigne);
...
//Backward position
ol::Rect Backward(ol::Vec2D(xp,yp+60),ol::Vec2D(28,16));
...
ol::Line(ol::Vec2D(xp+16,yp+62),ol::Vec2D(xp+16,yp+74)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+16,yp+62),ol::Vec2D(xp+6,yp+68)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+16,yp+74),ol::Vec2D(xp+6,yp+68)).Draw(CouleurLigne);

ol::Line(ol::Vec2D(xp+26,yp+62),ol::Vec2D(xp+26,yp+74)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+26,yp+62),ol::Vec2D(xp+16,yp+68)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+26,yp+74),ol::Vec2D(xp+16,yp+68)).Draw(CouleurLigne);

//Forward position
ol::Rect Forward(ol::Vec2D(xp+35,yp+60),ol::Vec2D(28,16));
...
ol::Line(ol::Vec2D(xp+36,yp+62),ol::Vec2D(xp+36,yp+74)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+36,yp+62),ol::Vec2D(xp+46,yp+68)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+36,yp+74),ol::Vec2D(xp+46,yp+68)).Draw(CouleurLigne);

ol::Line(ol::Vec2D(xp+46,yp+62),ol::Vec2D(xp+46,yp+74)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+46,yp+62),ol::Vec2D(xp+56,yp+68)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+46,yp+74),ol::Vec2D(xp+56,yp+68)).Draw(CouleurLigne);



//previous position
ol::Rect Previous(ol::Vec2D(xp,yp+85),ol::Vec2D(45,16));
...
//nEXT TRACK position
ol::Rect Next(ol::Vec2D(xp+50,yp+85),ol::Vec2D(45,16));
...
//NUM FICHIER
ol::Rect NumFichier(ol::Vec2D(xp+70,yp+55),ol::Vec2D(40,25));
...
//autoload cuelist
//audio_auto_load
ol::Rect Autoload(ol::Vec2D(xp,yp+110),ol::Vec2D(28,16));
...
ol::Line(ol::Vec2D(xp+3,yp+112),ol::Vec2D(xp+20,yp+112)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+20,yp+112),ol::Vec2D(xp+20,yp+123)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+20,yp+123),ol::Vec2D(xp+27,yp+118)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+13,yp+118),ol::Vec2D(xp+20,yp+123)).Draw(CouleurLigne);

//autopause
ol::Rect Autostop(ol::Vec2D(xp+35,yp+110),ol::Vec2D(40,16));
...
//SET cue IN
ol::Rect SetLoopIN(ol::Vec2D(xp+210,yp),ol::Vec2D(20,20));
...
ol::Line(ol::Vec2D(xp+210,yp),ol::Vec2D(xp+220,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+230,yp),ol::Vec2D(xp+220,yp+10)).Draw(CouleurLigne);
...
//SET cue out
ol::Rect SetLoopOut(ol::Vec2D(xp+235,yp),ol::Vec2D(20,20));
...
ol::Line(ol::Vec2D(xp+235,yp),ol::Vec2D(xp+245,yp+10)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+255,yp),ol::Vec2D(xp+245,yp+10)).Draw(CouleurLigne);
petitpetitchiffre.Print("out",xp+235,yp+17);


//CUE ON OFF
ol::Rect CueOn(ol::Vec2D(xp+260,yp),ol::Vec2D(20,20));
...
//Seek cue
ol::Rect SeekCue(ol::Vec2D(xp+210,yp+30),ol::Vec2D(20,20));
...
ol::Line(ol::Vec2D(xp+226,yp+34),ol::Vec2D(xp+226,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+226,yp+34),ol::Vec2D(xp+216,yp+40)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+216,yp+40),ol::Vec2D(xp+226,yp+46)).Draw(CouleurLigne);
ol::Line(ol::Vec2D(xp+214,yp+34),ol::Vec2D(xp+214,yp+46)).Draw(CouleurLigne);
...
//Pitch
ol::Line(ol::Vec2D(xp+130,yp+115),ol::Vec2D(xp+257,yp+115)).Draw(CouleurLigne);//ligne horizontale
ol::Line(ol::Vec2D(xp+194,yp+105),ol::Vec2D(xp+194,yp+125)).Draw(CouleurLigne);//barre 64
ol::Line(ol::Vec2D(xp+257,yp+110),ol::Vec2D(xp+257,yp+115)).Draw(CouleurLigne);//barre 127
ol::Rect PitchPos(ol::Vec2D(xp+120+player_pitch[numero],yp+110),ol::Vec2D(20,10));
PitchPos.SetRoundness(4);
PitchPos.Draw(CouleurBlind);
PitchPos.DrawOutline(CouleurLigne);
ol::Rect PitchMidi(ol::Vec2D(xp+130,yp+110),ol::Vec2D(127,10));
...
//Pan
ol::Line(ol::Vec2D(xp+130,yp+90),ol::Vec2D(xp+257,yp+90)).Draw(CouleurLigne);//ligne horizontale
ol::Line(ol::Vec2D(xp+194,yp+80),ol::Vec2D(xp+194,yp+100)).Draw(CouleurLigne);//barre 64
ol::Line(ol::Vec2D(xp+257,yp+85),ol::Vec2D(xp+257,yp+90)).Draw(CouleurLigne);//barre 127
ol::Rect PanPos(ol::Vec2D(xp+120+player_pan[numero],yp+85),ol::Vec2D(20,10));
PanPos.SetRoundness(4);
PanPos.Draw(CouleurBlind);
PanPos.DrawOutline(CouleurLigne);
ol::Rect PanMidi(ol::Vec2D(xp+130,yp+85),ol::Vec2D(127,10));
...
ol::Rect audio_backg(ol::Vec2D(xb,yb), ol::Vec2D( 600,150+(index_nbre_players_visibles*120)));
...
//FOLDER
ol::Rect AudioFolderis(ol::Vec2D(xb+350,yb+10),ol::Vec2D(240,30));
...
ol::Rect BackDeroule(ol::Vec2D(xb+350,yb+45),ol::Vec2D(240,(index_nbre_players_visibles*120)));
...
{
ol::Rect OverAudioFile(ol::Vec2D(xb+355,(yb+33+(y*20))),ol::Vec2D(200,18));
...
ol::Canvas::SetClipping( xb+355,yb+35+(y*20),230,20);
petitpetitchiffre.Print(list_audio_files[line_audio+y],xb+375,yb+45+(y*20));
ol::Canvas::DisableClipping();
}

//////////////////UP DOWN LINE IMPORT/////////////////////
ol::Circle LineUp(ol::Vec2D(xb+570,yb+65),12);
LineUp.Draw(CouleurFond);
ol::Circle LineDown(ol::Vec2D(xb+570,yb+(index_nbre_players_visibles*120)),12);
...
///RESCAN FOLDER
    ol::Rect AudioRescanDriver( ol::Vec2D(xb+230,yb+10), ol::Vec2D( 50,20));
    AudioRescanDriver.SetRoundness(7.5);
    AudioRescanDriver.DrawOutline(CouleurLigne);

////////////////////////////////////////////////////////////////////////////////
//EDIT ON OFF
   ol::Rect EditSound( ol::Vec2D(xb+230,yb+40), ol::Vec2D( 50,20));
...
//ol::Rect AffectA(ol::Vec2D(xb+440,yb+450),ol::Vec2D(140,20));
ol::Rect AffectA(ol::Vec2D(xb+440,yb+55+(index_nbre_players_visibles*120)),ol::Vec2D(140,20));
...
{
 ol::Rect AffectAudioType(ol::Vec2D(xb+460+(pl*30),yb+90+(index_nbre_players_visibles*120)+(co*20)),ol::Vec2D(20,15));
